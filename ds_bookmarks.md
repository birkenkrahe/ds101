...
1.  [Interesting applications](#orged69269)
    1.  [EDA of a bank dataset (R programming series)](#orgfe3ea05)
    2.  [Run your own R analysis of people's Google searches](#orga3d58ed)
    3.  [Space Shuttle disaster and linear regression model](#org8371e46)
    4.  [COVID-19](#org6a0b1c7)
        1.  [Covid-19: The global crisis — in data](#org1b7d167)
        2.  [Comparing COVID-19 to seasonal influenza (7 Oct 2020)](#orgf20c6c1)
        3.  [Paper: homogenous COVID-19 response (Sept 1, 2020)](#org881d8e9)
        4.  [Leading Causes of Mortality by U.S. County](#org7de2704)
        5.  [Visualization of COVID-19 Cases in Arkansas](#orgc7faf39)
        6.  [Excess Deaths by Cause](#orgf790a0f)
        7.  [How to Assess Risks During the Coronavirus Pandemic](#org1bcaaaf)
        8.  [US Excess Mortality](#org3ae51a3)
        9.  [Issues with the "flatten the curve" meme and chart? (FastCompany 13 March 2020)](#org2607993)
        10. [COVID-19 cases in India drop every Sunday - how to explain?](#org7bad01d)
        11. [Severity Score Derivation](#org76b3de8)
        12. [Does the chart support the text? (COVID-19 and economic data)](#org8eec4d8)
        13. [Risk of catching a fatal case of COVID-19 is like having a bath (Sept 2020)](#orga6e8cf6)
        14. [Twitter discussion example (June 2020)](#orgc4e567d)
        15. [Micromort = one-in-a-million chance of death risk unit](#orgca23d3f)
        16. [Track COVID-19 Data Yourself with R](#org7c968ce)
        17. [How to Think Like an Epidemiologist (NYT, 4 Aug 2020)](#orgc8777d5)
        18. [covid19italy v0.3.0 is now on CRAN](#org7785f35)
        19. [This Chart Predicts Which Colleges Will Survive the Coronavirus](#orgc644008)
        20. [You’re Not Measuring COVID-19 Correctly](#orga9ee2d3)
        21. [Hands-on: How to build an interactive map in R-Shiny: An example for the COVID-19 Dashboard](#org067b19a)
        22. [Data Mining COVID-19 Epidemics with Orange](#orgd1f5095)
    5.  [Sentiment Analysis in R with Custom Lexicon Dictionary using tidytext](#org5a2b59a)
    6.  [Five Factors Across the Business Cycle](#orgaf89e8c)
    7.  [Automation tips](#orgee7674d)
        1.  [Everything I Automated In 2020 To Save Me Hours Of Time](#org4f26fcc)
        2.  [How to Automate PDF Reporting with R](#orgfaa2c0a)
        3.  [How to Automate Excel with R](#orgdd1bd9b)
    8.  [Why R? Text Mining Hackathon Summary](#org694f3e1)
    9.  [tayloR (22 Jul 2018)](#orgddc8989)
    10. [What Matters in Speed Dating?](#org9efe5ac)
    11. [Science as Amateur Development (YouTube R McElreath) / p-hacking etbc.](#orga237abb)
    12. [How to scrape WORD documents in R](#orgae15231)
    13. [Using Drake for ETL - Building A Shiny Real Estate App](#org2cb2f2f)
    14. [Support for protests&#x2026;compassion fatigue? (June vs Sept 2020)](#orgab1917e)
    15. [Tracking historical changes in trustworthiness](#org45abe32)
    16. [Exploring 30 years of local CT weather history with R](#org48ac0c2)
    17. [R for Excel users](#org22c7d44)
    18. [How to Automate PowerPoint Slidedecks with R](#orgcc55e1b)
    19. [100 Time Series Data Mining Questions (with answers!) part 1-3](#org64b4f47)
    20. [Nobel-prize winners for Biden](#orgf0a7c55)
    21. [Officer R package - manipulate Word and PPT documents](#orgff15cdb)
    22. [Have R Look After Your Stocks!](#orgd681b04)
    23. [Analysing campaign contributions (2018-2020)](#org02905ee)
    24. [R for Health Data Science (book)](#orgc6db6bf)
    25. [Movie recommender system (DS portfolio) with Tableau (Medium blog post)](#org61b678f)
    26. [Hegel vs Nietzsche NLP](#orgf10fe9b)
    27. [Star Wars Fandom Survey](#org0ca219d)
    28. [Genomic data science (coursera)](#orga36d7f0)
    29. [Introduction to survival analysis (customer churn/retention)](#org45877ea)
    30. [Tidy Tuesday live screencast: Analyzing European energy in R](#orged981dc)
    31. [Sharing pictures from holidays in the Canadian Rockies (with R)](#orgdb2e1e6)
    32. [The Goldilocks Principle - investing in stocks](#orga4b2a4b)
    33. [Customer Churn – Logistic Regression with R (2017)](#orgfddd25b)
    34. [Twitter text analysis: The Most Popular Towards Data Science Article Topics on Twitter](#orgd9712d1)
    35. [Labor force growth by decade (plot)](#orgabf77b0)
    36. [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#orgd1a5d92)
    37. [Earthquake early warning system](#org613b619):node:red:ibm:
    38. [International Space Station](#org309809c)
    39. [Credit Risk Modelling using Machine Learning using R](#orgb14dfc0)
    40. [How to create a timeline of your CV in R?](#orgaf6d953)
    41. [Crime by the numbers (R for criminologists)](#orgde96a3c)
    42. [Qualitative Data Science: Using RQDA to analyse interviews](#orge4fcf3e)
    43. [Discourse Network Analysis: Undertaking Literature Reviews in R](#org7e68e96)
    44. [Movement data in GIS](#orgd35ab92)
    45. [Complex societies precede moralizing gods throughout world history](#orge8fff28)
    46. [Brownian motion](#org3fec4f0)
        1.  [Simulating Brownian Motion in R](#orgc02c044)
    47. [The rise of the Netflix hit](#org34435b1)
    48. [Google teaches ML to journalists](#org723aa7a)
    49. [Guide to Classification on Imbalanced Datasets](#org69a866b)
    50. [Automatically create draw.io diagrams from CSV files](#orgf15c83d)
    51. [How to Build a Video Game in R Shiny with CSS, JavaScript, and R6 Classes](#org6ae5c79)
    52. [Pacific Island Hopping using R and the iGraph package](#orgc4d387b)
    53. [Website building: Export WordPress to Hugo Markdown or Org Mode with R](#org93a0a0b)
    54. [A Complete Introduction to Apache Airflow (automating workflows)](#org7f62214)
    55. [RTutor: Quantifying Social Spillovers in Movie Ticket Sales](#org5ac735d)
    56. [Build a Chatbot with R](#orgc2b5f18)
    57. [Dataquest data science projects](#orge122054)
    58. [Experiences Building a Production Shiny App for Mobile](#orgdc91606)
    59. [17 classification algorithms using R](#orgd3e73eb)
    60. [Comet - ds and ml wrapper](#org50a7395)
    61. [ISING Model (Quanta Mag)](#org198b604)
    62. [Social network analysis with igraph (tutorial)](#orgfa186ef)
    63. [Riddles](#org46c2861)
    64. [Games](#org094a6b4)
2.  [Careers](#orgf5602ec)
    1.  [Getting to know the Kaggle Grandmasters (youTube playlist)](#orgab1c04f)
    2.  [datacamp - The L&D Guide to Data Fluency](#org4db800e):ATTACH:
    3.  [How Much is a Data Scientist Worth in 2020?](#org17d8f84)
    4.  [Podcast "A career in data science"](#org87f6ee4)
    5.  [How You Should Change Your Data Science Education](#org95a2fc4)
    6.  [Professional Machine Learning Engineer (Google)](#orgf5e61b8)
    7.  [50 Questions to Test True Data Science Knowledge](#org98844dd)
    8.  [Data Science questions](#org6921f69)
    9.  [Data Scientist’s 2020 Toolbox: A List of Tools to Increase Your Productivity](#org896597e)
    10. [Some Important Data Science Tools that aren’t Python, R, SQL or Math](#orgcab16b9)
    11. [The Essential Skills Most Data Science Courses Won’t Teach You](#orgbb82756)
    12. [Top 9 Data Science Careers of the Future](#orgd2fba63)
    13. [Data Science’s Most Misunderstood Hero](#org87e2301)
    14. [Data Science Concepts Explained to a Five-year-old](#org2d9cb49)
    15. [I Worked Through 500+ Data Science Interview Questionsg](#org82d0b41)
    16. [Business Analytics vs Data Analytics in One Picture](#org1c021d6)
    17. [The Role of the Data Scientist](#org7dd28c1)
    18. [How a Biologist Became a Data Scientist](#org9046245)
    19. [Data science pioneers (movie, 60 min, 2020)](#org0cb7efd)
    20. [Curiosity-Driven Data Science (27 Nov 2018)](#org824dadc)
    21. [66 job interview questions for data scientists (13.2.2013)](#org456e54e)
    22. [Data science workflow: Overview and Challenge (Philip Guo 10/2013)](#orgd4180cf)
    23. [Twelve Tips for Data-Driven Research (Philip Guo, Nov 2015)](#orgfa76998)
    24. [Data Scientist: The Sexiest Job of the 21st Century (HBR 10/2012)](#org83c1464)
    25. [What Data Scientists Really Do, According to 35 Data Scientists (HBR 15.8.2018)](#orgd983c41)
    26. [Discover data science - How to become a data scientist (programs)](#orgb718986)
    27. [Data Scientist: The Dirtiest Job of the 21st Century (20.2.20)](#org34a61ff)
    28. [How I went from zero coding skills to data scientist in 6 months (2020)](#org6182404)
    29. [How I Would Learn Data Science (If I Had to Start Over) (2020)](#org15647b5)
    30. [How To Learn Data Science If You’re Broke (2018)](#org30bc14e)
    31. [If I had to start learning Data Science again, how would I do it? (2020)](#orgc3d2024)
    32. [Yes, You Can Become a Data Scientist Online. Here’s How. (19.5.20)](#org94b9acb)
3.  [R](#org6c1aa00)
    1.  [Packages](#org756cbe0)
        1.  [R Packages: A Beginner's Guide](#orgffffee1)
        2.  [Your first R package in 1 hour](#org73d7133)
        3.  [data.table](#orga6bde85)
        4.  [Tidyverse](#org0e9d442)
        5.  [gt for tables](#orge189973)
        6.  [Rolling Averages with {slider} and Covid Data (Oct 2020)](#orgf2b7ec8)
        7.  [Package for colorblind plots](#org267ad87)
        8.  [feedeR: Reading RSS and Atom Feeds from R](#org6f8ad37)
        9.  [Reinstall missing LaTeX packages with TinyTex](#orgea6d0f7)
        10. [lessr](#org42b7d5e)
        11. [How to simplify your code by using data flows](#orgfcd0c8a)
        12. [What to do when R tells you it can't install a package](#org5376237)
        13. [Fodil's many packages (utilities/presentation)](#org6b1f95a)
        14. [covdata - COVID-19 specific case and mortality data](#orgc58e633)
        15. [How to Explore Data: {DataExplorer} Package](#org10a9aa4)
        16. [Tidytable: tidyverse functions with data.table speed](#org0040672)
        17. [Text mining with R and quanteda](#org5285888)
        18. [renv - Why Package & Environment Management](#orge2f7fd6)
        19. [Introduction to the DataRobot R Package](#orgd7c9827)
        20. [library() vs package vs ls() vs vignette](#org49979a1)
        21. [Package leaderboard & book](#org31a3f0b)
    2.  [R vs Python](#org85e00f5)
        1.  [Choosing Python or R for Data Analysis? An Infographic](#org8320e2d)
        2.  [Python vs. R: A Text Mining Approach for analyzing the Research Trends in Scopus Database](#orgc44f8e9)
        3.  [Trying R for the First Time](#org15e09e4)
        4.  [Debunking R and Python Myths: Answering Your Questions](#org6ef53b2)
        5.  [How R still outperforms Python](#org5105b06)
    3.  [My Year in R (Oct 15, 2020)](#org8bd3950)
    4.  [Little useless-useful R function](#org3b10954)
    5.  [The evolution of distributed programming in R](#orga5cb886)
    6.  [Hack: How To Convert All Character Variables To Factors](#orgc803ddd)
    7.  [How To Get Data From Different Sources In R](#org67188ba)
    8.  [Apply family functions - Part 1](#orge81168b)
    9.  [The Fastest Way To Read And Write Files In R](#org688e2a5)
    10. [Finding factorials](#org17045f6)
    11. [Data manipulation in r using data frames - an extensive article of basics](#org1c9a394)
    12. [How to Extract Day from Datetime in R with Examples](#orgf83e3cc)
    13. [How to subset a data frame column data in R](#org560fe5d)
    14. [Common R error messages](#org4550a37)
    15. [A Guide to the Pipe in R](#org9b8c638)
    16. [Visualize as flow diagrams](#org3ee5efb)
    17. [Demonstrating the central limit theorem in R](#org440b9ff)
    18. [R & RStudio - The Interoperability Environment for Data Analytics](#orgcd5bae8)
    19. [First sample sessions (R documentation)](#org342e370)
    20. [metR - meteorogical (tidy) data package](#orgc711271)
    21. [How to evaluate R Packages](#org3d2bbc0)
    22. [R Style guides](#orgeadcfcc)
        1.  [R code style guide richie cotton](#orgc53e8a5)
        2.  [R-Style-Guide &#x2013; Towards a Goal of RED Code (Matloff 2019)](#orgf1e14cc)
        3.  [R Style guide (jean)](#org3ad0fd9)
        4.  [Google’s R Style Guide](#org7485d7c)
        5.  [Bioconductor (bioinformatics)](#org9206286)
    23. [Working with text in R (presentation)](#org0eb9818)
    24. [doubleheadR (surveymonkey data analysis)](#org66217cb)
    25. [magrittr - pipeline library](#orgb79bf07)
        1.  [compound assignment operator `%<>%`](#org8699931)
    26. [Functional Programming in R with purrr](#org02ec64d)
    27. [Few things I learned while writing an R package](#org7a2079c)
    28. [Unit Testing in R](#orga24e5ad)
    29. [Building a collection of Hello World functions in R](#org9ab76c8)
    30. [Build a Corporate R Package for Pleasure and Profit by Brad Lindblad, Mar 5, 2019](#orgd0cad36)
    31. [Doing Maths Symbolically: R as a Computer Algebra System (CAS)](#org787ecc7)
    32. [Five Tidyverse Tricks You May Not Know About](#org11f46c2)
    33. [How to write your own R package and publish it on CRAN](#org91b3e6f)
    34. [Setting up your R environment (webinar w/Richie Cotton)](#orgf1bffec)
    35. [R Coding Style Guide](#org6f98e7a)
    36. [Installing R 4.0 under Ubuntu 18.04](#org3425018)
    37. [Text Mining with R (bookdown)](#org2eedeaf)
    38. [causaloptim: An Interface to Specify Causal Graphs and Compute Bounds on Causal Effects](#org3e4aebf)
    39. [Machine learning using H2O](#orga446a42)
    40. [Learning R With Education Datasets](#org07ae67f)
    41. [Select first or last rows of a data frame](#org436d31d)
    42. [Good coding style (Wickham, Advanced R)](#org317ad04)
    43. [formatr: Format code automatically (Yhui Yie, 2019)](#org590b94e)
    44. [Performance Optimization in R: Parallel Computing and Rcpp](#orgd91cdf4)
    45. [R Exercisesp](#orgddca86e)
    46. [R Programming 101 (YouTube Playlist Data Professor)](#org51a92f9):R:RStudio:
    47. [Testing statistical packages in R](#org1cfa5a6)
    48. [Ten more random useful things in R you may not know about](#orgdd3c7ac)
    49. [Onboard Help System: help.start()](#org88a7967)
    50. [How to do more with R (playlist)](#orgcb484a0)
    51. [The Seven Key Things You Need To Know About dplyr 1.0.0](#org1ab90f2)
    52. [A Year in Review of R Programming 2019](#org7c1ea0f)
    53. [R Programming Pundits (Telegram channel) - free tutorials](#orgf008c8b)
    54. [Programming with R (online tutorial)](#org2e20a42)
    55. [Introduction to R and RStudio (online tutorial)](#org8700664)
    56. [R for Data Science (book, 2017)](#org743b91c)
    57. [Vlog by Philip Guo on the R ecosystem and R for Data Science - 5 Feb 2018](#org7b60fd9)
    58. [Ten Time-Saving R Hacks (27.2.20)](#orgcbee56a)
    59. [Textmining with R (book - 2014)](#org70f2e91)
    60. [Geocomputation with R (book - 2018)](#org139c475)
    61. [Build interactive tutorials with learnr (2020)](#org29f9263)
    62. [Example: setting up R, RStudio, tidyverse R package](#orgb3eba9f)
    63. [R and Jupyter Notebook](#orga42340e)
    64. [Datacamp blog (30 Nov 2016)](#orge526110)
4.  [Datasets](#orgafd1252)
    1.  [Searching medRxiv and bioRxiv Preprint Data](#orgdd76092)
    2.  [Every Place I’ve Gotten Data For Data Science Projects, Rated](#org1c5f828)
    3.  [Useful sites for finding datasets for Data Analysis tasks](#org6cbbd5f)
    4.  [CDC vital statistics](#org23159fe)
    5.  [satellite data](#org9832da8)
    6.  [Unsplash’s dataset is now open source](#org7135636)
    7.  [Google dataset search](#org7e29381)
    8.  [HWR Datenbanken](#org72cf28c)
    9.  [Penguins Dataset Overview - iris alternative in R](#orgd88c830)
    10. [Cleaning Data in R (datacamp course) - case studies](#orgb1aa2e0)
    11. [Importing data in R (datacamp course)](#orgaa13d56)
    12. [Google datasets](#org562e751)
    13. [How to Collect Data for Your Analysis (June 6, 2020)](#orgeb4d938)
    14. [data.gov.uk](#orgac814e9)
    15. [17 Free Financial & Economic Datasets for Machine Learning](#org178f65e)
    16. [AWS Open Datasets](#orgebd1d99)
    17. [Amazon Customer Reviews](#org026d88e)
    18. [Getting Started With SpaceNet Data](#orgd1e1b16)
    19. [18 Places to Find Free Data Sets for Data Science Projects](#org40f9830)
    20. [Andrew Heiss' collection (political science)](#orge3ba75a)
    21. [COVID-19 Data Hub](#org9044794)
    22. [R built in Data Sets](#org8c33a04)
    23. [19 Free Public Data Sets for Your Data Science Project](#org78e5393)
    24. [US Census Bureau - Employment data](#org3d2c5d5)
    25. [dslabs (HarvardX)](#orgb35f764)
    26. [Learning R on iris (2016)](#org8990ac0)
5.  [Blogs worth reading](#org6e5a14a)
    1.  [Will Kurt Count Bayesie](#org9fa0ce3)
        1.  [Why Bayesian Stats Needs Monte-Carlo Methods](#org5490235)
    2.  [“One Year of Data Science Blogging — Was it Worth it?”](#orgdf56573)
    3.  [Data Science is a Science (Just Not the One You May Think)](#org7088e9e)
    4.  [Megan Stodel](#org4248859)
    5.  [Anita Graser](#orgaa61e4a)
    6.  [pete werner - Density plots in ggplot](#org9b8aaa1)
    7.  [Corey Sparks R blog (demographic modeling - cluster analysis)](#orgc31b937)
    8.  [Quantum jitter](#org61c5c80)
    9.  [Richie Cotton 4D Pie Charts](#org8b1fe48)
    10. [Martin Johnsson's blog about genetics](#org8b9a0b6)
    11. [Guest blogging R-posts.com](#org7b6da1d)
    12. [Mathew Analytics (e.g. R code review)](#org9247515)
    13. [Statistical modeling, causal inferene, and social science](#org2054470)
    14. [R Rendering - Tylermw](#org57c347c)
    15. [Sebastian Kranz](#org3118142)
    16. [18 great blog posts from 2016](#org54a5a7b)
    17. [List of top data science blogs 2020 (via Hi! I am Nagdev)](#org0666f25)
    18. [Joshua Cook - Riddler](#org51d44f5)
    19. [R-Bloggers](#org1880c6d)
    20. [Radford Neal - COVID-19](#orga3b21d5)
    21. [Holker K. von Jouanne-Diedrich](#orgad27abc)
    22. [https://physicsgarage.com/](#orge48c8c9)
    23. [Publishable Stuff / Rasmus Baath](#org1ea48cc)
    24. [Xi'An's OG](#orgbbf405c)
    25. [Radford Neal's blog](#orgaa6094d)
    26. [Vicky Boykis](#org75aca31)
    27. [Markus Lang](#org677c3c5)
    28. [Aerin Kim](#orgc7c9a2c)
    29. [Cassie Kozyrkov](#orgfae958f)
    30. [Tim Gowers](#org04f5897)
    31. [RStudio Blog](#org3fe2470)
    32. [RWeekly](#orgc14fbb8)
6.  [Visualization](#orgc8a7ec4)
    1.  [Upping your dataviz game (Claus O Wilke)](#org6ba74d2)
    2.  [Data-GIF](#org657e83d)
    3.  [Animated GIF in Mathematica - turn into R?](#org748fac4)
    4.  [R Programming for Beginners | The Ultimate Guide to GGPLOT2: Scatter Plots (video)](#orge483396)
    5.  [The Good, the Bad and the Ugly: how (not) to visualize data](#orgf261c07)
    6.  [Personal Art Map with R](#orgf530a56)
    7.  [Building an animation step-by-step with gganimate](#org46d594a)
    8.  [TwoTone visualizing data with sound and music (Google)](#orgeca6c6b)
    9.  [Visualizing Google Data (via trends.google.com)](#org1dc42eb)
    10. [Finding the Shortest Path with Dijkstra’s Algorithm](#org335aad7)
    11. [Snap! visualization - pointillism](#org9f5b464)
    12. [A short tutorial for decent heat maps in R](#orgf9907b9)
    13. [Challenges](#org7e0d2b3)
        1.  [Does the chart support the text? (COVID-19 and economic data)](#orgec85484)
        2.  [Issues with the "flatten the curve" meme and chart? (FastCompany 13 March 2020)](#org685ce4e)
    14. [D3.js — How to Make a Beautiful Bar Chart With The Most Powerful Visualization Library](#org9df7a8d)
    15. [“What Data Visualisation Experts Wish They Knew When They First Started”](#org8aaea6a)
    16. [Tutorial: Plotting in R for Python Refugees](#org364fbeb)
    17. [Microsoft Research: Expressive Pixels](#orgfd7259b)
    18. [Most popular on Netflix. Daily Tops for last 60 days](#org72960a7)
    19. [How dynamic is the browser market?](#org3ed3cab)
    20. [Energy consumption in last 140 years](#org0f91753)
    21. [Gapminder](#org8a97eb5)
        1.  [How to build Animated Charts like Hans Rosling — doing it all in R](#org2de6821)
        2.  [Exploring the Gapminder Data with R](#orgff90bcd)
        3.  [Empfehlungen Roland Müller (Rosling pro and con):](#orga8a2598)
    22. [ggplot](#org04517f6)
    23. [Create a line graph with ggplot](#org764f364)
        1.  [Dataquest beginner's tutorial ggplot2](#orgb97e5bd)
        2.  [Graphics in R with ggplot2](#org8f6aef9)
        3.  [ggplot2 easthetics cheat sheet](#org90770f4)
        4.  [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#orgcf56d76)
        5.  [A ggplot2 Tutorial for Beautiful Plotting in R](#org9366b3c)
        6.  [Tutorial: why data visualization is important (ggplot2)](#org93cbf90)
        7.  [Writing Functions to Automate Repetitive Plotting Tasks in ggplot2](#org97bf16d)
        8.  [a ggplot2 grammar guide](#org81051af)
        9.  [Top 50 ggplot2 Visualizations - The Master List (with full R code)](#org82bac9f)
        10. [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#orgf3d89cb)
    24. [Abstractions - Physarum model visualizations](#orgf438612)
    25. [You’re Plotting the Wrong Things](#org828f4bf)
    26. [Analytics is not storytelling (Kozyrkov](#orgc2f0988)
    27. [You Can Design a Good Chart with R](#org9597332)
    28. [The Goldilocks Principle - investing in stocks (beautiful graphs)](#org9d2ffa9)
    29. [Embed Interactive Plots in Your Slides with Plotly](#org4d8584e)
    30. [PowerPoint is evil (E Tufte, 9 Jan 1983)](#orgc7a9bf5)
    31. [Cheesecake Diagrams: Pie Charts with a Different Flavour](#org684dfef)
    32. [Demo: Create beautiful charts with Datawrapper](#org94c128e)
    33. [A Comprehensive Guide to the Grammar of Graphics for Effective Visualization of Multi-dimensional Data](#orge03ff4e)
    34. [Visualization examples](#org9f07a6f)
        1.  [Making Interactive Maps in R with Less Than 15 Lines of Code](#orgd3f53ca)
        2.  [Sqrt(2) puzzle animation](#org8505e9c)
        3.  [Power socket types Europe (Twitter account gesperrt!)](#org24b55d9)
        4.  [Size of Africa](#org1c4f6b9)
    35. [fabricerin package to draw on shinyapp documents (?)](#org9f6d00e)
    36. [The ultimate EDA visualization in R (raincloud plots)](#orgbcf8756)
    37. [SpaceX Satellites Ruin Perfectly Good View of Comet NEOWISE](#org896b6c3)
    38. [Re-engineer graphs to extract the data (WebPlotDigitizer)](#org2620de8)
    39. [COVID-19 cases in India drop every Sunday - how to explain?](#org7e6368f)
    40. [Animated charts: visualizing “changes” in R](#orgb3e5ed7)
    41. [Making Interactive Maps of Public Data in R by Ryan Rosenberg](#orgacc064d)
    42. [ggtext - formating text in graphs](#org35fe723)
    43. [A Layered Grammar of Graphics](#orgf6c7ca7)
    44. [My top 5 visualization tools for data science](#orgeec5e70)
    45. [Visualization good/bad examples](#orgcde2010)
    46. [How to Visualize Data with R](#org660f0fa)
    47. [Hadley Wickham: Managing many models with R (2016)](#orge97ab5a):modeling:R:wickham:video:
    48. [Past project examples (Andrew Heiss)](#org585d634)
    49. [R Visualizations David Gerbing 2020](#orgafd61d4)
    50. [Online course in data visualization with R (May 2020) - Georgia State U / Dr Andrew Heiss](#org93c892e)
    51. [Free book: Data Visualization with R (Rob Kabacoff, 2018)](#org56344e2)
    52. [Free book: Data Visualization - A practical introduction](#orgf1f561f)
    53. [Free book: Fundamentals of Data Visualization by Claus O Wilke](#org206ac93)
    54. [Easy Ways to Make Your Charts Look More Professional 28 May 2020](#org1bd5807)
    55. [Stacked Bar Graphs, Why and How 28 May 2020](#org4eb3082)
    56. [Effective Visualizations for Credible, Data-Driven Decision Making (16.4.20)](#org2904cbf)
    57. [Visualisation example: Data Privacy in the Age of Big Data](#org9d884b7)
    58. [Practical Implications of Sharing Data: A Primer on Data Privacy,](#orgc64a384)
7.  [RMarkdown / R Notebook / learnr / RTutor / OER](#org24b053c)
    1.  [glosario](#orge341491)
    2.  [Tableau vs. R Shiny: Which Excel Alternative Is Right For You?](#orge4665f1)
    3.  [From R to WordPress in two easy steps](#org3f84faf)
    4.  [Image clipper into RStudio (add-in)](#orge4d8e68)
    5.  [Getting started with R and RStudio (Dataquest tutorial)](#org399466c)
    6.  [Replacing PowerPoint with R](#org6bd8a24)
    7.  ["Dashboards are dead" see also https://count.co](#org9173c64)
    8.  [Interactive R tutorials with learnr (youtube)](#orgd2b39be)
    9.  [Tips and tricks in RStudio and R Markdown](#orgf8b9967)
    10. [Jupyter Notebooks](#org6f05300)
    11. [Literate Programming](#org0826123)
        1.  [Org-mode litprog in Emacs (2018) - long youtube video](#org357edaa)
        2.  [Configuring Emacs with Org mode and literate programming](#orgc85253e)
        3.  [Interview with Donald Knuth (1993) - LitProg, CWEB](#org9865e51)
        4.  [Stanford page on LitProg](#orgd96c45f)
        5.  [LitProg article by Knuth 1984](#orgbcab806)
        6.  [The CWEB System of Structured Documentation (1993-2001)](#orgb91f729)
        7.  [LitProg - Propaganda and Tools (Christopher Lee 1994)](#orge198f5c)
    12. [DS in education](#orge5b462f)
        1.  [Open-Source Authorship of Data Science in Education Using R,](#orgc668597)
    13. [R Markdown](#org488d026)
        1.  [Converting LaTeX to Bookdown (accessible lecture notes)](#org6ea468e)
        2.  [How R Markdown changed my life (video 23 min)](#orga61fb48)
        3.  [Meta RMarkdown - Taxonomy and Use cases](#org6608602)
        4.  [Useful YAML options for generating HTML reports in R](#orgc7b1ff9)
        5.  [R Markdown Crash course (bookdown)](#org2318a47)
        6.  [Book: Practical R for Mass Communication and Journalism](#orgda1d3db)
        7.  [Course: Datacamp course R Markdown](#org54a24c6):datacamp:
        8.  [RTutor](#org10597b1)
        9.  [Interactive Tutorials for R](#org52e9f86):R:learnr:
        10. [Markdown + XMInd (Blog)](#org07e5a6c)
        11. [How I teach R Markdown 29.5.2020](#orgaa0d336)
        12. [Making slides with xaringan 16.1.2019](#orgaef971e)
        13. [R Markdown Tutorial (Video 2018, 8 min)](#orgd5af029)
        14. [Advantages of Using R Notebooks For Data Analysis Instead of Jupyter Notebooks (6.6.17)](#orgcda0d1e)
        15. [Markdown Tutorial](#org9b2d193)
        16. [Pimp my RMD: a few tips for R Markdown by Yan Holtz - 10 December 2018](#org4ddeb2e)
        17. [Bookdown - R Markup](#org35b0f00)
        18. [R Markdown from R Studio](#org4482aba)
    14. [learnr](#org16a0043)
        1.  [Teaching in learnr](#org00582a1)
        2.  [Publishing learnr Tutorials on shinyapps.io](#org162ea2b)
8.  [Dashboards](#orge9c5f3d)
    1.  [Power BI vs R Shiny](#org1f441ef)
9.  [Emacs / ESS](#orgec8fc5b)
10. [Teaching - other courses and ideas](#org03fa776)
    1.  [R for Journalists (tutorial)](#orgdf474b7)
    2.  [Learning guide: Introduction to R, one-day workshop](#orgf12db31)
    3.  [STAT 220 labs Amelia McNamara](#org700418e)
    4.  [A fresh look at introductory data science (paper 2020)](#org74f61cb)
    5.  [Data science in a box (tidyverse, learnr)](#orgafadebe)
    6.  [DS112 tutorials (net apps, learnR and GitHub exercises)](#orgae496d2)
        1.  [R Basics](#org65b8d7b)
        2.  [ggplot() and dplyr tutorial](#orga31a0da)
    7.  [Teaching Statistics with R](#org16fa766)
    8.  [Future of Statistical Programming](#orgcb4de41)
    9.  [Bridging the Gap Between Tools for Learning and for Doing Statistics](#org26b6649)
    10. [Codementor](#org012eadf)
    11. [Online course: Adventures in R](#orgd5df63b)
    12. [Proposal for an educational data science course](#org3fe8fff)
    13. [R Studio Cloud Primers](#org18766d0)
    14. [How I Taught Scientific Blogging with R Markdown, Online](#org5a224db)
    15. [RStudio Instructor Certification Exams](#org34e4672)
    16. [Market analysis course (interactive, free, and with a lot of R)](#org66f1079)
    17. [R for Bio Data Science (DTU Wiki)](#org710c678)
    18. [Data science for biologists (playlist youtube)](#org6fb2e1b)
    19. [A novice’s guide to learning to code with CS50](#orgba635b9)
    20. [Introduction to SQL (Coursera)](#org02700ba)
    21. [Syllabus](#orgee3e466)
    22. [Mismatch Between Academic and Real-world Data Science Projects](#org90a369b)
    23. [UC Berkeley Connector Courses](#orgc42173f)
    24. [John DeNero | YouTube |  Intro Foundations of Data Science Intro | Online Book](#org57fea23)
    25. [Computational and inferential thinking | Online book](#orgcabf74b)
    26. [Data 8 - The foundations of data science (UC Berkeley) | Site: data8.org | Spring 2020 syllabus](#org0841594)
    27. [Harvard edX Program](#org9b79edf)
    28. [Heidi Seibold | video 55 min |  presentation](#org2a7e8f0)
    29. [The Johns Hopkins Data Science Lab](#org6178d26)
11. [Data wrangling](#org0b57506)
    1.  [Cleaning ecological survey data for conservation scientists](#orga50675a)
    2.  [Cleaning messy data with tidyverse](#org69a5630)
    3.  [Data Cleaning and Exploratory Analysis in Python and R](#orgf89e347)
    4.  [Beyond Ordinary PCA: Nonlinear Principal Component Analysis](#org6e9879c):medium:
12. [Git/Github](#org7b7777b)
    1.  [Happy Git and GitHub for the useR (bookdown)](#org36ba605)
    2.  [Git Emacs integration](#org75ff2e3)
    3.  [How to upload your R code on GitHub: example with an R script on MacOS](#orgc7c37fe)
    4.  [The State of the Octoverse](#orgab8166c)
    5.  [Building a blog using github and jekyll](#org8a259b6)
    6.  [Using GitHub Actions for MLOps & Data Science](#orgd637fcb)
    7.  [BIRKENKRAHE @github](#org48f5023)
    8.  [Git Your SQL Together (with a Query Library)](#orgca84419)
    9.  [Using GitHub Classroom to teach statistics (paper 2019)](#orge45bb58)
    10. [How to use Git and Github with R (15 min video)](#org32723eb)
    11. [How to upload your R code on GitHub: example with an R script on MacOS (24.5.20)](#orge79fa23)
    12. [Why You Should Blog with Hugo?An Introduction to the 'Blog with Hugo'](#orgf7bbab3)
13. [Mixed Links](#orgf0bce6b)
14. [Math](#orgdb162f9)
    1.  [Modeling](#org42b677f)
        1.  [Democratizing data science](#org8b437ca)
        2.  [Tidy Modeling with R (Kuhn & Silge, 2020)](#org5629c19)
        3.  [Feature Engineering and Selection: A Practical Approach for Predictive Models](#org25f4a8a)
    2.  [ML](#orgd1161a7)
        1.  [Math Companion to The Art of Machine Learning](#org296bed3):matloff:pdf:
    3.  [Stats](#org4ebc5db)
        1.  [The Central Limit Theorem (CLT): From Perfect Symmetry to the Normal Distribution](#orgdd1a474)
        2.  [Basic Statistics Using Excel: t-tests, effect sizes, figures, tables, and reporting in manuscripts](#org779faca)
        3.  [Bayesian Statistics using R, Python, and Stan](#org2ee87a0)
        4.  [Daniela Witten's "Four Cardinal Rules of Statistics" (Tweets)](#org5cf829f)
        5.  [The Lacking Wisdom of Crowds](#org9e80908)
        6.  [Why Bayesian Stats Needs Monte-Carlo Methods](#orgd7e1a55)
        7.  [Introduction to Probability (2nd 3d) PDF](#orgcfe7cbc)
        8.  [A trick question for data science buffs](#org88e3bf7)
        9.  [Descriptive vs Inferential Statistics in One Picture](#org99bbfe2)
        10. [What the Null Hypothesis Really Means— According to a Statistics Professor](#org1dc706e)
        11. [P-values Explained By Data Scientist](#org75b0d88)
        12. [How most statistical tests are linear models (with cheat sheet)](#org83ddaf0)
        13. [What is p-value short for? (Kozyrkov)](#orgbb5763e)
        14. [The Magic of The Bell Curve (turn Python script into R)](#org61a9c1e)
        15. [Monte Carlo Simulation in R (see also Matloff 2020)](#orge018f80)
        16. [Outliers detection in R](#org330a720)
        17. [Stop using p=0.05](#org9599d03)
        18. [Essentially random isn't the same as actually random](#orge63748d)
    4.  [General maths](#org7a6f741)
        1.  [The Directed Edge Reinforced Random Walk: The Ant Mill Phenomenon](#orgcf82f8b)
        2.  [Understanding Mathematical Symbols with Code](#orgf9515d9)
        3.  [A computational approach to the Prisoner’s Dilemma](#org7472d83)
        4.  [What is Graph Theory, and why should you care?](#org664ab93)
        5.  [Matrices are Graphs (12 Aug 2020)](#org12ef7e8)
        6.  [The Fastest Way to Compute the Fibonacci Sequence](#org97dc4b0)
        7.  [The Collatz Conjecture](#org47f8b35)
        8.  [The Riemann Hypothesis, explained](#orgcf4d699)
        9.  [What is the determinant?](#org1c4964b)
        10. [A Tribute to Leonard Euler (youtube)](#org3d05967)
        11. [Philosophy of Mathematics (Stanford Encyclopedia of Philosophy)](#orgde00149)
        12. [Introduction to Group Theory (see also book by Charles Pinter, kindle)](#org8e605fb)
        13. [Six Difficult Ways of Becoming a Millionaire by Francesco Di Lallo](#org9019bf2)
        14. [The algebra and machine representation of statistical models (PhD)](#org009f353)
        15. [Mathematics for machine learning (book)](#org8d2bb3e)
        16. [Statistics with R specialization @Coursera](#org804cf29)
        17. [Business statistics and analysis specialization @Coursera](#org3f70d81)
        18. [Statistics and probability in data science using Python](#org55474fa)
        19. [Linear algebra: foundations to frontiers @edX](#orgbc838de)
        20. [Mathematics for machine learning: linear algebra @Coursera](#orgc95e875)
        21. [Pre-university calculus @edX](#org0a66e4f)
        22. [Calculus I @KhanAcademy](#org9a3bc3e)
        23. [Mathematics for machine learning: multivariable calculus  \* Discrete Mathematics <code>[0/8]</code>](#org6216a35)
        24. [Introduction to discrete mathematics for computer science specialization @Coursera](#org1e402e2)
        25. [Introduction to mathematical thinking @Coursera](#org7fa793f)
        26. [Master discrete mathematics: sets, math logic, and more @Udemy](#org3b73eb8)
        27. [Optimization methods in business analytics @edX](#org58c313b)
        28. [Discrete optimization @Coursera](#org73e85ca)
        29. [Deterministic optimization @edX](#orge098f8c)
15. [NN](#orge934f9b)
    1.  [Artificial Neural Networks for Neuroscientists: A Primer](#org3cd271f)
    2.  [The Neural Network, A Visual Introduction | Visualizing Deep Learning](#org758acca)
    3.  [RobustFill: Neural Program Learning under Noisy I/O (2017)](#org28dcc7a)
    4.  [Building a neural net from scratch using R (part 1, part 2)](#orgf10d171)
    5.  [The Beginner’s Glossary of Neural Network Terms](#orge4e8145)
    6.  [Every Machine Learning Algorithm Can Be Represented as a Neural Network](#org27bc947)
    7.  [NN and ML vs Stats (culture wars)](#orgae85ada)
    8.  [BrainOS — The Most Brain-Like AI](#orgff875fa)
    9.  [Understanding How Neural Networks Think](#orgcf33b36)
    10. [Can you remove 99% of a neural network without losing accuracy?](#orgb60ab18)
    11. [Symbolic Mathematics Finally Yields to Neural Networks](#orgde42ee6)
    12. [Explainable AI: Neural Networks (IBM)](#org37bb3b2)
    13. [Why are neural networks so powerful?](#org7eb691e)
    14. [22 articles about NN Jan 2019g](#orgf78d8c5)
16. [RStudio / IDEs / GUI](#orga0ec57c)
    1.  [GUIs and the Future of Work](#orgc9394e4)
    2.  [RStudio addins, or how to make your coding life easier](#orgef3fa69)
    3.  [Do, Share, Teach, and Learn Data Science with RStudio Cloud, Lou](#orgbd77316)
    4.  [A Dashboard of Shiny Apps by Andy Merlino 2020/07/17](#orgdaf7d8b)
    5.  [keyboard shortcuts and tips and tricks](#org63e3f01)
    6.  [Using version control with RStudio](#orgaf75709)
    7.  [Interactive code with Shiny - Example](#orgad71739)
    8.  [Xaringan presentations](#orgd6ba777)
    9.  [Connections window / database connections in RStudio](#org8c6bacc)
    10. [RStudio Primers (cloud) created using learnr (github)](#org8d70387)
    11. [RStudio Blog](#org73afe0e)
17. [AI/ML](#org7a81f5f)
    1.  [Recreating Historical Streetscapes Using Deep Learning and Crowdsourcing](#org7ee78b0)
    2.  [CausalWorld: A Robotic Manipulation Benchmark for Causal Structure and Transfer Learning](#orgd14f8e4)
    3.  [The 2020 data and AI landscape](#org11ee450)
    4.  [Interpretable Machine Learning &#x2013; A Brief History, State-of-the-Art and Challenges](#org462a941)
    5.  [Classifying images with torch](#org75caf6b)
    6.  [Self-Organizing Intelligent Matter: A blueprint for an AI generating algorithm](#org7316b52)
    7.  [R packages for eXplainable Artificial Intelligence](#orgf088ade)
    8.  [A Beginner’s Guide To Computer Vision](#orge8acab2)
    9.  [How I Explained Word Embeddings To My Non-Technical Colleagues](#org2049128)
    10. [The Difference Between AI and Machine Learning (datacamp blog)](#org939108a)
    11. [Supervised Machine Learning for Text Analysis in R](#org5c4be1e)
    12. [What Types of Questions Can Data Science Answer?](#orga46ab55)
    13. [Deep AI engines example "How to become a data scientist in 30 days?"](#org4dd68df)
    14. [Game Theory for Data Scientists](#org410f5a9)
    15. [Facial Recognition Bans: What Do They Mean For AI (Artificial Intelligence)?](#org618d8a3)
    16. [Core progress in AI has stalled in some fields 29.5.20](#org50f60c0)
    17. [The limits of knowledge - Gödel, Turing, and the science of what we can and cannot know](#org7ed564f)
    18. [Computing Machinery and Intelligence (A M Turing 1950)](#org804f386)
    19. [What is the relevance of Gödel's theorem(s) to AI?](#orgaf5df11)
    20. [Platonist Roger Penrose “Sees” Mathematical Truths (19 May 2020)](#orga971ffe)
    21. [The remarkable evolution of AI (5 May 2020)](#orgfd708a0)
    22. [IBM claims its Neural Computer achieves record AI model training time (14 May 2020)](#orgfe28bc9)
    23. [The computers of nature - Cellular automata and the emergence of computation in natural systems](#orgc49370d)
18. [SQL/(R)SQLite](#org9c748b1)
    1.  [Intro to SQL at Kaggle w/Google BigQuery](#org76fcc7e)
    2.  [Kickstarter SQL style guide](#org3717c03)
    3.  [How To Connect R With SQL (PostGreSQL)](#org8969ebb)
    4.  [How to Learn SQL (Datacamp blog)](#orgd178aae)
    5.  [Machine learning example with SQL only](#orgf46d718)
    6.  [Data Lakes vs. Data Warehouses](#org3726e33)
    7.  [Apache Spark, JDBC, sparklyr](#org33ce676)
    8.  [R and ODBC – Pulling Data From A SQL Database](#org773967b)
    9.  [4 SQL Tips for Data Scientists and Data Engineers](#org014a730)
    10. [SQL equivalents in R](#org6342f7f)
    11. [Building Complex SQL Queries with R](#org2f88428)
    12. [Ten SQL Concepts You Should Know for Data Science Interviews](#orgea0267a)
    13. [Linear Regression with SQL (whitepaper) & R Notebook](#org8be9ad9)
    14. [Using SQL in RStudio (29.4.20)](#orgd0a12f5)
    15. [Appropriate uses for SQLite](#orgfefab09)
    16. [Relational Algebra (tutorialspoint)](#org52459de)
    17. [RSQLite](#org34c50f2):rsqlite:
        1.  [access in RStudio with the connections pane](#orgb773cd4)
        2.  [Read Data from an SQLite Database (video 8 min)](#org4e7adc7)
        3.  [RSQLite = SQLite in R](#org988b878)
        4.  [Beginners Guide to SQLite (in R)](#orgbd1e3d4)
    18. [JSON (JavaScript Object Notation) Files](#orge1aea31)
        1.  [RJSON package](#org23a0ed9)
        2.  [Tutorial: Working with Large Data Sets using Pandas and JSON in Python](#orgffa45fe)
    19. [SQL Joins Grafik](#org05b485d)
    20. [SQL Data Types (Mode)](#org0c5d4e3)
    21. [Crunchbase - data dashboard solution](#org00f26ae)
    22. [SQL for Data Scientists, in Under 6 Minutes](#orgfcac9d9)
    23. [SQL Case Study: Investigating a Drop in User Engagement](#org76483d2)
    24. [SQL Case Study: Investigating a Drop in User Engagement (21 May 2020)](#org708e804)
19. [NLP](#org420414f)
    1.  [State-of-the-art NLP models from R:](#org03430ef)
    2.  [A Guide to Text Annotation — the Key to Understanding Language](#orgfd397b6)
    3.  [Datacamp: natural language processing in R](#orge8d2c31)
20. [Blockchain](#orga84306b)
...
-   [covdata - COVID-19 specific case and mortality data](#orgc58e633)


<a id="org2607993"></a>

### [Issues with the "flatten the curve" meme and chart? (FastCompany 13 March 2020)](#org685ce4e)


<a id="org7bad01d"></a>

### [COVID-19 cases in India drop every Sunday - how to explain?](#org7e6368f)
...
## [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#orgcf56d76)
...
1.  [10 Must-Know Tidyverse Features!](https://www.business-science.io/code-tools/2020/10/15/must-know-tidyverse-features.html)

    Written by Jim Gruman on October 15, 2020

2.  [Tidy correlation tests in R](https://dominicroye.github.io/en/2019/tidy-correlation-tests-in-r/)
...
3.  [Hack: The “count(case when … else … end)” in dplyr](https://predictivehacks.com/hack-the-countcase-when-else-end-in-dplyr/)
...
4.  [New relocate() function](https://youtu.be/swm3smjU0RU)

5.  [Ten Up-To-Date Ways to do Common Data Tasks in R](https://towardsdatascience.com/ten-up-to-date-ways-to-do-common-data-tasks-in-r-4f15e56c92d)

    Stay up to date with these ten simple examples using a dataset of
    cute penguins

6.  [Missing value visualization with tidyverse in R](https://towardsdatascience.com/missing-value-visualization-with-tidyverse-in-r-a9b0fefd2246)
...
## TODO [My Year in R (Oct 15, 2020)](https://amitlevinson.com/post/my-year-in-r/)
...
### [Does the chart support the text? (COVID-19 and economic data)](#org8eec4d8)
...
### [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#orgd1a5d92)
...
## [The Goldilocks Principle - investing in stocks](#orga4b2a4b) (beautiful graphs)
...
-   [Git Emacs integration](#org75ff2e3)
...
### [Why Bayesian Stats Needs Monte-Carlo Methods](#org5490235)
