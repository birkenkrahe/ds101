...
1.  [Interesting applications](#orgfca5489)
    1.  [COVID-19](#orgd7127f7)
        1.  [Visualization of COVID-19 Cases in Arkansas](#orgde10540)
        2.  [Excess Deaths by Cause](#orgb136207)
        3.  [How to Assess Risks During the Coronavirus Pandemic](#org44747d1)
        4.  [US Excess Mortality](#org743d417)
        5.  [Issues with the "flatten the curve" meme and chart? (FastCompany 13 March 2020)](#orgfd3a3a3)
        6.  [COVID-19 cases in India drop every Sunday - how to explain?](#org1e1aca7)
        7.  [Severity Score Derivation](#org5a1d252)
        8.  [Does the chart support the text? (COVID-19 and economic data)](#orgad437e4)
        9.  [Risk of catching a fatal case of COVID-19 is like having a bath (Sept 2020)](#orgcc39f23)
        10. [Twitter discussion example (June 2020)](#org4582445)
        11. [Micromort = one-in-a-million chance of death risk unit](#orge55f9f1)
        12. [Track COVID-19 Data Yourself with R](#orga51ca18)
        13. [How to Think Like an Epidemiologist (NYT, 4 Aug 2020)](#org1c5a4bd)
        14. [covid19italy v0.3.0 is now on CRAN](#orge408e72)
        15. [This Chart Predicts Which Colleges Will Survive the Coronavirus](#org80787c5)
        16. [You’re Not Measuring COVID-19 Correctly](#org5c9e5fa)
        17. [Hands-on: How to build an interactive map in R-Shiny: An example for the COVID-19 Dashboard](#org9cb1ca1)
        18. [Data Mining COVID-19 Epidemics with Orange](#org1daba7e)
    2.  [Five Factors Across the Business Cycle](#org6710dd8)
    3.  [Automation tips](#org856fc0d)
        1.  [How to Automate PDF Reporting with R](#org764e435)
        2.  [How to Automate Excel with R](#org75aac90)
    4.  [Why R? Text Mining Hackathon Summary](#org96ab0f9)
    5.  [tayloR (22 Jul 2018)](#orgd04a761)
    6.  [What Matters in Speed Dating?](#org7d907a5)
    7.  [Science as Amateur Development (YouTube R McElreath) / p-hacking etbc.](#orgfa7a3cc)
    8.  [How to scrape WORD documents in R](#org90dc2a6)
    9.  [Using Drake for ETL - Building A Shiny Real Estate App](#orgc1b9692)
    10. [Support for protests&#x2026;compassion fatigue? (June vs Sept 2020)](#org738c4b2)
    11. [Tracking historical changes in trustworthiness](#org2460811)
    12. [Exploring 30 years of local CT weather history with R](#orgb5cd462)
    13. [R for Excel users](#orgd3efb5b)
    14. [How to Automate PowerPoint Slidedecks with R](#org4003b9e)
    15. [100 Time Series Data Mining Questions (with answers!) part 1-3](#org781063b)
    16. [Nobel-prize winners for Biden](#org59c1648)
    17. [Officer R package - manipulate Word and PPT documents](#org90e9af2)
    18. [Have R Look After Your Stocks!](#orgf2a884d)
    19. [Analysing campaign contributions (2018-2020)](#org194c057)
    20. [R for Health Data Science (book)](#org674c2a9)
    21. [Movie recommender system (DS portfolio) with Tableau (Medium blog post)](#org91d4dc9)
    22. [Hegel vs Nietzsche NLP](#org6cb6eb8)
    23. [Star Wars Fandom Survey](#orga9d16cc)
    24. [Genomic data science (coursera)](#org731754e)
    25. [Introduction to survival analysis (customer churn/retention)](#org391252d)
    26. [Tidy Tuesday live screencast: Analyzing European energy in R](#orgf83b3ed)
    27. [Sharing pictures from holidays in the Canadian Rockies (with R)](#org979f5a4)
    28. [The Goldilocks Principle - investing in stocks](#org8e809af)
    29. [Customer Churn – Logistic Regression with R (2017)](#org7409756)
    30. [Twitter text analysis: The Most Popular Towards Data Science Article Topics on Twitter](#org674cae1)
    31. [Labor force growth by decade (plot)](#org6890ca3)
    32. [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#orgeb2c742)
    33. [Earthquake early warning system](#orgd7f869e):node:red:ibm:
    34. [International Space Station](#org6787761)
    35. [Credit Risk Modelling using Machine Learning using R](#org5f9ef94)
    36. [How to create a timeline of your CV in R?](#orgd74043a)
    37. [Crime by the numbers (R for criminologists)](#orgada206f)
    38. [Qualitative Data Science: Using RQDA to analyse interviews](#org9366b41)
    39. [Discourse Network Analysis: Undertaking Literature Reviews in R](#org455bd33)
    40. [Movement data in GIS](#orgcb74eb3)
    41. [Complex societies precede moralizing gods throughout world history](#org43a68ff)
    42. [Brownian motion](#org7025ea2)
        1.  [Simulating Brownian Motion in R](#org4197c0a)
    43. [The rise of the Netflix hit](#org1c6363f)
    44. [Google teaches ML to journalists](#orgd1954a0)
    45. [Guide to Classification on Imbalanced Datasets](#org8455de4)
    46. [Automatically create draw.io diagrams from CSV files](#org2cbff8d)
    47. [How to Build a Video Game in R Shiny with CSS, JavaScript, and R6 Classes](#orgc496e15)
    48. [Pacific Island Hopping using R and the iGraph package](#orgdb50eac)
    49. [Website building: Export WordPress to Hugo Markdown or Org Mode with R](#org3722a39)
    50. [A Complete Introduction to Apache Airflow (automating workflows)](#org9aece86)
    51. [RTutor: Quantifying Social Spillovers in Movie Ticket Sales](#org70d9c4d)
    52. [Build a Chatbot with R](#orgbe720bf)
    53. [Dataquest data science projects](#org4bef998)
    54. [Experiences Building a Production Shiny App for Mobile](#org572ee51)
    55. [17 classification algorithms using R](#orgf497b99)
    56. [Comet - ds and ml wrapper](#orge378de9)
    57. [ISING Model (Quanta Mag)](#orgfe683ca)
    58. [Social network analysis with igraph (tutorial)](#orgc0b163a)
    59. [Riddles](#org3ca3e4c)
    60. [Games](#org2365019)
2.  [Careers](#org67f47af)
    1.  [datacamp - The L&D Guide to Data Fluency](#orgf7193ca):ATTACH:
    2.  [How Much is a Data Scientist Worth in 2020?](#org0deb86a)
    3.  [Podcast "A career in data science"](#orgac33d40)
    4.  [How You Should Change Your Data Science Education](#org1df299d)
    5.  [Professional Machine Learning Engineer (Google)](#orgb4ee8ba)
    6.  [50 Questions to Test True Data Science Knowledge](#org551c026)
    7.  [Data Science questions](#org975f63d)
    8.  [Data Scientist’s 2020 Toolbox: A List of Tools to Increase Your Productivity](#orgaf8bc7d)
    9.  [Some Important Data Science Tools that aren’t Python, R, SQL or Math](#orge131ba4)
    10. [The Essential Skills Most Data Science Courses Won’t Teach You](#orgb5f7ded)
    11. [Top 9 Data Science Careers of the Future](#org542b770)
    12. [Data Science’s Most Misunderstood Hero](#org9f6e177)
    13. [Data Science Concepts Explained to a Five-year-old](#org1c21246)
    14. [I Worked Through 500+ Data Science Interview Questionsg](#orgfd9d1a4)
    15. [Business Analytics vs Data Analytics in One Picture](#org4a7feb9)
    16. [The Role of the Data Scientist](#orgbd4cb35)
    17. [How a Biologist Became a Data Scientist](#org10eb798)
    18. [Data science pioneers (movie, 60 min, 2020)](#org9ed756f)
    19. [Curiosity-Driven Data Science (27 Nov 2018)](#orgac0ce30)
    20. [66 job interview questions for data scientists (13.2.2013)](#orge29138e)
    21. [Data science workflow: Overview and Challenge (Philip Guo 10/2013)](#org95f765b)
    22. [Twelve Tips for Data-Driven Research (Philip Guo, Nov 2015)](#org7ea517b)
    23. [Data Scientist: The Sexiest Job of the 21st Century (HBR 10/2012)](#org01ed95b)
    24. [What Data Scientists Really Do, According to 35 Data Scientists (HBR 15.8.2018)](#orga007030)
    25. [Discover data science - How to become a data scientist (programs)](#org16ca024)
    26. [Data Scientist: The Dirtiest Job of the 21st Century (20.2.20)](#orge7903fd)
    27. [How I went from zero coding skills to data scientist in 6 months (2020)](#org081aa81)
    28. [How I Would Learn Data Science (If I Had to Start Over) (2020)](#orga76d9ea)
    29. [How To Learn Data Science If You’re Broke (2018)](#orge52f6b1)
    30. [If I had to start learning Data Science again, how would I do it? (2020)](#org5e69d14)
    31. [Yes, You Can Become a Data Scientist Online. Here’s How. (19.5.20)](#orgaadd1ab)
3.  [R](#org81f7d58)
    1.  [Packages](#org03183b4)
        1.  [data.table](#org371adbd)
        2.  [tidyverse](#orgb67e07b)
        3.  [Reinstall missing LaTeX packages with TinyTex](#org1438548)
        4.  [lessr](#org5f4b194)
        5.  [How to simplify your code by using data flows](#orgde98799)
        6.  [What to do when R tells you it can't install a package](#orgae4f139)
        7.  [Fodil's many packages (utilities/presentation)](#org0d8865d)
        8.  [covdata - COVID-19 specific case and mortality data](#orgad564fa)
        9.  [How to Explore Data: {DataExplorer} Package](#orgec74124)
        10. [Tidytable: tidyverse functions with data.table speed](#org9907a1c)
        11. [Text mining with R and quanteda](#org2577535)
        12. [renv - Why Package & Environment Management](#org1e37fb7)
        13. [R Packages: A Beginner's Guide](#orgdd56f3f)
        14. [Introduction to the DataRobot R Package](#orgc649702)
        15. [library() vs package vs ls() vs vignette](#org9e5727e)
        16. [Package leaderboard & book](#orga2de837)
    2.  [R vs Python](#org7722fc5)
        1.  [Choosing Python or R for Data Analysis? An Infographic](#org50682af)
        2.  [Python vs. R: A Text Mining Approach for analyzing the Research Trends in Scopus Database](#org3cb6492)
        3.  [Trying R for the First Time](#orgbb25740)
        4.  [Debunking R and Python Myths: Answering Your Questions](#orgbde6ae5)
        5.  [How R still outperforms Python](#orgf2c56c3)
    3.  [Hack: How To Convert All Character Variables To Factors](#orgc14cc27)
    4.  [How To Get Data From Different Sources In R](#orgee1f2d7)
    5.  [Apply family functions - Part 1](#org42ff9a0)
    6.  [The Fastest Way To Read And Write Files In R](#org16c1289)
    7.  [Finding factorials](#orgdb3fc80)
    8.  [Data manipulation in r using data frames - an extensive article of basics](#org2ebe717)
    9.  [How to Extract Day from Datetime in R with Examples](#org8addc32)
    10. [How to subset a data frame column data in R](#orgfff1d29)
    11. [Common R error messages](#orgc1949b5)
    12. [A Guide to the Pipe in R](#orgec7f17c)
    13. [Visualize as flow diagrams](#org6db69dd)
    14. [Demonstrating the central limit theorem in R](#org9d05312)
    15. [R & RStudio - The Interoperability Environment for Data Analytics](#orgd6a383b)
    16. [First sample sessions (R documentation)](#org8064067)
    17. [metR - meteorogical (tidy) data package](#org2e072ec)
    18. [How to evaluate R Packages](#orgeea13dd)
    19. [R Style guides](#orge935fc8)
        1.  [R code style guide richie cotton](#orgd3c484f)
        2.  [R-Style-Guide &#x2013; Towards a Goal of RED Code (Matloff 2019)](#orgecf40bf)
        3.  [R Style guide (jean)](#org354675b)
        4.  [Google’s R Style Guide](#orgcb00316)
        5.  [Bioconductor (bioinformatics)](#org41e5f92)
    20. [Working with text in R (presentation)](#org8f8595b)
    21. [doubleheadR (surveymonkey data analysis)](#org2e8afc0)
    22. [magrittr - pipeline library](#org15c7865)
    23. [Functional Programming in R with purrr](#orge8c7e7e)
    24. [Few things I learned while writing an R package](#org788272b)
    25. [Unit Testing in R](#orgc84f43e)
    26. [Building a collection of Hello World functions in R](#org6edbe27)
    27. [Build a Corporate R Package for Pleasure and Profit by Brad Lindblad, Mar 5, 2019](#org8eba191)
    28. [Doing Maths Symbolically: R as a Computer Algebra System (CAS)](#org24ab067)
    29. [Five Tidyverse Tricks You May Not Know About](#org49bfaa5)
    30. [How to write your own R package and publish it on CRAN](#org1cddcad)
    31. [Setting up your R environment (webinar w/Richie Cotton)](#org4f98938)
    32. [R Coding Style Guide](#org2cebe89)
    33. [Installing R 4.0 under Ubuntu 18.04](#org6dccf9b)
    34. [Text Mining with R (bookdown)](#org5a22004)
    35. [causaloptim: An Interface to Specify Causal Graphs and Compute Bounds on Causal Effects](#org31c1246)
    36. [Machine learning using H2O](#org6542d22)
    37. [Learning R With Education Datasets](#org04bed06)
    38. [Select first or last rows of a data frame](#orga907796)
    39. [Good coding style (Wickham, Advanced R)](#orgd3d6d60)
    40. [formatr: Format code automatically (Yhui Yie, 2019)](#org180b7c7)
    41. [Performance Optimization in R: Parallel Computing and Rcpp](#orgdea7ab2)
    42. [R Exercises](#orgc1bb68a)
    43. [R Programming 101 (YouTube Playlist Data Professor)](#org48d4c70):R:RStudio:
    44. [Testing statistical packages in R](#org703fccd)
    45. [Ten more random useful things in R you may not know about](#orgcb53680)
    46. [Onboard Help System: help.start()](#org9748944)
    47. [How to do more with R (playlist)](#orgfc62478)
    48. [The Seven Key Things You Need To Know About dplyr 1.0.0](#org396208f)
    49. [A Year in Review of R Programming 2019](#orge0b9649)
    50. [R Programming Pundits (Telegram channel) - free tutorials](#org0a0ba01)
    51. [Programming with R (online tutorial)](#org7e6daea)
    52. [Introduction to R and RStudio (online tutorial)](#orgaed0302)
    53. [R for Data Science (book, 2017)](#org40dd821)
    54. [Vlog by Philip Guo on the R ecosystem and R for Data Science - 5 Feb 2018](#orgdbd49c5)
    55. [Ten Time-Saving R Hacks (27.2.20)](#org7451307)
    56. [Textmining with R (book - 2014)](#orgaaf861d)
    57. [Geocomputation with R (book - 2018)](#org3a285af)
    58. [Build interactive tutorials with learnr (2020)](#org9a26f4c)
    59. [Example: setting up R, RStudio, tidyverse R package](#orgc0b19f3)
    60. [R and Jupyter Notebook](#org50171eb)
    61. [Datacamp blog (30 Nov 2016)](#orgc62751c)
4.  [Datasets](#org214b863)
    1.  [Every Place I’ve Gotten Data For Data Science Projects, Rated](#org53e28f6)
    2.  [Useful sites for finding datasets for Data Analysis tasks](#org6d34213)
    3.  [CDC vital statistics](#org4bf046a)
    4.  [satellite data](#org02d7657)
    5.  [Unsplash’s dataset is now open source](#orgea4455b)
    6.  [Google dataset search](#org8feca3d)
    7.  [HWR Datenbanken](#orgb71f0b6)
    8.  [Penguins Dataset Overview - iris alternative in R](#org961223b)
    9.  [Cleaning Data in R (datacamp course) - case studies](#org0fc422b)
    10. [Importing data in R (datacamp course)](#orga9138db)
    11. [Google datasets](#org761d486)
    12. [How to Collect Data for Your Analysis (June 6, 2020)](#orgfd69104)
    13. [data.gov.uk](#org4b1685a)
    14. [17 Free Financial & Economic Datasets for Machine Learning](#orgbc415ab)
    15. [AWS Open Datasets](#org9196984)
    16. [Amazon Customer Reviews](#orga726e24)
    17. [Getting Started With SpaceNet Data](#org6dc3a4c)
    18. [18 Places to Find Free Data Sets for Data Science Projects](#org5260298)
    19. [Andrew Heiss' collection (political science)](#org390bc5b)
    20. [COVID-19 Data Hub](#org065cc3f)
    21. [R built in Data Sets](#org47bf504)
    22. [19 Free Public Data Sets for Your Data Science Project](#org74d869f)
    23. [US Census Bureau - Employment data](#org45a8953)
    24. [dslabs (HarvardX)](#org904e76f)
    25. [Learning R on iris (2016)](#orgff94083)
5.  [Blogs worth reading](#orge6c71df)
    1.  [Will Kurt Count Bayesie](#orgdee4042)
        1.  [Why Bayesian Stats Needs Monte-Carlo Methods](#orgd849354)
    2.  [“One Year of Data Science Blogging — Was it Worth it?”](#org86b7e1d)
    3.  [Data Science is a Science (Just Not the One You May Think)](#org9cb50ff)
    4.  [Megan Stodel](#org97d427c)
    5.  [Anita Graser](#orgf6a22a8)
    6.  [pete werner - Density plots in ggplot](#orga4cca1f)
    7.  [Corey Sparks R blog (demographic modeling - cluster analysis)](#org87bde4e)
    8.  [Quantum jitter](#org1133c54)
    9.  [Richie Cotton 4D Pie Charts](#orgbd7d274)
    10. [Martin Johnsson's blog about genetics](#org34ea450)
    11. [Guest blogging R-posts.com](#org071878f)
    12. [Mathew Analytics (e.g. R code review)](#org0aa8cf1)
    13. [Statistical modeling, causal inferene, and social science](#org647dc8c)
    14. [R Rendering - Tylermw](#org4ddcd82)
    15. [Sebastian Kranz](#org2f5da19)
    16. [18 great blog posts from 2016](#org567f65d)
    17. [List of top data science blogs 2020 (via Hi! I am Nagdev)](#org1e51f7d)
    18. [Joshua Cook - Riddler](#org2eff96d)
    19. [R-Bloggers](#orgd1d4abe)
    20. [Radford Neal - COVID-19](#orgf99109d)
    21. [Holker K. von Jouanne-Diedrich](#org6e16f98)
    22. [https://physicsgarage.com/](#org1779d42)
    23. [Publishable Stuff / Rasmus Baath](#orgc9343f9)
    24. [Xi'An's OG](#org490df36)
    25. [Radford Neal's blog](#orgd2893a5)
    26. [Vicky Boykis](#org826ffb0)
    27. [Markus Lang](#org652194a)
    28. [Aerin Kim](#orgc9df475)
    29. [Cassie Kozyrkov](#org32ab051)
    30. [Tim Gowers](#org4c7e600)
    31. [RStudio Blog](#org0b8c3bb)
    32. [RWeekly](#org7adbc87)
6.  [Visualization](#org4699021)
    1.  [Visualizing Google Data (via trends.google.com)](#org90f8041)
    2.  [Finding the Shortest Path with Dijkstra’s Algorithm](#orgbaa537a)
    3.  [Snap! visualization - pointillism](#org6586749)
    4.  [A short tutorial for decent heat maps in R](#org2f02add)
    5.  [Challenges](#orge4b9018)
        1.  [Does the chart support the text? (COVID-19 and economic data)](#orga25522b)
        2.  [Issues with the "flatten the curve" meme and chart? (FastCompany 13 March 2020)](#orgfd44a74)
    6.  [D3.js — How to Make a Beautiful Bar Chart With The Most Powerful Visualization Library](#org74bde77)
    7.  [“What Data Visualisation Experts Wish They Knew When They First Started”](#org79f60ae)
    8.  [Tutorial: Plotting in R for Python Refugees](#org8ab3072)
    9.  [Microsoft Research: Expressive Pixels](#orgd9a0de4)
    10. [Most popular on Netflix. Daily Tops for last 60 days](#org32c42b5)
    11. [How dynamic is the browser market?](#org5eed53e)
    12. [Energy consumption in last 140 years](#org6f3ca0b)
    13. [Gapminder](#org58a8755)
        1.  [How to build Animated Charts like Hans Rosling — doing it all in R](#orgff9e081)
        2.  [Exploring the Gapminder Data with R](#org284ebbc)
        3.  [Empfehlungen Roland Müller (Rosling pro and con):](#org46f4af4)
    14. [ggplot](#orga307b9f)
    15. [Create a line graph with ggplot](#org2288117)
        1.  [Dataquest beginner's tutorial ggplot2](#org8ee922e)
        2.  [Graphics in R with ggplot2](#org17c4086)
        3.  [ggplot2 easthetics cheat sheet](#orge2f39d4)
        4.  [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#orgf3d5d11)
        5.  [A ggplot2 Tutorial for Beautiful Plotting in R](#org0013738)
        6.  [Tutorial: why data visualization is important (ggplot2)](#org06f1112)
        7.  [Writing Functions to Automate Repetitive Plotting Tasks in ggplot2](#orgcbcf72b)
        8.  [a ggplot2 grammar guide](#org96a58ab)
        9.  [Top 50 ggplot2 Visualizations - The Master List (with full R code)](#orgbea8566)
        10. [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#org2a2e89d)
    16. [Abstractions - Physarum model visualizations](#org0be6b27)
    17. [You’re Plotting the Wrong Things](#org4f68f13)
    18. [Analytics is not storytelling (Kozyrkov](#org25670a5)
    19. [You Can Design a Good Chart with R](#orgaa09a10)
    20. [The Goldilocks Principle - investing in stocks (beautiful graphs)](#org5262981)
    21. [Embed Interactive Plots in Your Slides with Plotly](#org8d5b7fb)
    22. [PowerPoint is evil (E Tufte, 9 Jan 1983)](#org410c642)
    23. [Cheesecake Diagrams: Pie Charts with a Different Flavour](#org5f26cf4)
    24. [Demo: Create beautiful charts with Datawrapper](#org5414c34)
    25. [Making tables with the gt package](#org68f7b76)
    26. [A Comprehensive Guide to the Grammar of Graphics for Effective Visualization of Multi-dimensional Data](#orge16bedf)
    27. [Package for colorblind plots](#orgef453ef)
    28. [Guide to gt tables (Richard Iannone)](#orgcec9f18)
    29. [Visualization examples](#org3dde648)
        1.  [Making Interactive Maps in R with Less Than 15 Lines of Code](#org58d2fa8)
        2.  [Sqrt(2) puzzle animation](#org2d7345b)
        3.  [Power socket types Europe (Twitter account gesperrt!)](#org3580608)
        4.  [Size of Africa](#org525180a)
    30. [fabricerin package to draw on shinyapp documents (?)](#org1fcba48)
    31. [The ultimate EDA visualization in R (raincloud plots)](#org7dea4a6)
    32. [SpaceX Satellites Ruin Perfectly Good View of Comet NEOWISE](#orgc65a6dc)
    33. [Re-engineer graphs to extract the data (WebPlotDigitizer)](#orgc9e7b33)
    34. [COVID-19 cases in India drop every Sunday - how to explain?](#org15485ba)
    35. [Animated charts: visualizing “changes” in R](#org3914681)
    36. [Making Interactive Maps of Public Data in R by Ryan Rosenberg](#org2fe2d7c)
    37. [ggtext - formating text in graphs](#orgb7865ee)
    38. [A Layered Grammar of Graphics](#org9a8a4af)
    39. [My top 5 visualization tools for data science](#org21cd85d)
    40. [Visualization good/bad examples](#orge094ade)
    41. [How to Visualize Data with R](#orgbd64d85)
    42. [Hadley Wickham: Managing many models with R (2016)](#orgc66678e):modeling:R:wickham:video:
    43. [Past project examples (Andrew Heiss)](#org10dbd51)
    44. [R Visualizations David Gerbing 2020](#orgec6440b)
    45. [Online course in data visualization with R (May 2020) - Georgia State U / Dr Andrew Heiss](#orge3c659c)
    46. [Free book: Data Visualization with R (Rob Kabacoff, 2018)](#org7796c61)
    47. [Free book: Data Visualization - A practical introduction](#org9ba0e64)
    48. [Free book: Fundamentals of Data Visualization by Claus O Wilke](#org7ea4fad)
    49. [Easy Ways to Make Your Charts Look More Professional 28 May 2020](#orgdd9a20c)
    50. [Stacked Bar Graphs, Why and How 28 May 2020](#orgcc38a9a)
    51. [Effective Visualizations for Credible, Data-Driven Decision Making (16.4.20)](#orgca48524)
    52. [Visualisation example: Data Privacy in the Age of Big Data](#org4565160)
    53. [Practical Implications of Sharing Data: A Primer on Data Privacy,](#org139946e)
7.  [RMarkdown / R Notebook / learnr / RTutor / OER](#org278c18d)
    1.  [From R to WordPress in two easy steps](#org1392c33)
    2.  [Image clipper into RStudio (add-in)](#org3138c9a)
    3.  [Getting started with R and RStudio (Dataquest tutorial)](#org3403434)
    4.  [Replacing PowerPoint with R](#org391b740)
    5.  ["Dashboards are dead" see also https://count.co](#orga39c7b5)
    6.  [Interactive R tutorials with learnr (youtube)](#org8340d9d)
    7.  [Tips and tricks in RStudio and R Markdown](#orga788d1e)
    8.  [Jupyter Notebooks](#orgc8bec64)
    9.  [Literate Programming](#org07e051e)
        1.  [Org-mode litprog in Emacs (2018) - long youtube video](#org5af0bb2)
        2.  [Configuring Emacs with Org mode and literate programming](#org500e4b1)
        3.  [Interview with Donald Knuth (1993) - LitProg, CWEB](#org3e4825d)
        4.  [Stanford page on LitProg](#org5e18c39)
        5.  [LitProg article by Knuth 1984](#org42b5ce3)
        6.  [The CWEB System of Structured Documentation (1993-2001)](#orgeec37f7)
        7.  [LitProg - Propaganda and Tools (Christopher Lee 1994)](#orgf95c621)
    10. [DS in education](#orge3ec74b)
        1.  [Open-Source Authorship of Data Science in Education Using R,](#org48052a2)
    11. [R Markdown](#org4dda4a0)
        1.  [Converting LaTeX to Bookdown (accessible lecture notes)](#orge2f6ed9)
        2.  [How R Markdown changed my life (video 23 min)](#orgf0db677)
        3.  [Meta RMarkdown - Taxonomy and Use cases](#org7dbbdc0)
        4.  [Useful YAML options for generating HTML reports in R](#org47fc574)
        5.  [R Markdown Crash course (bookdown)](#org816dece)
        6.  [Book: Practical R for Mass Communication and Journalism](#org0aca939)
        7.  [Course: Datacamp course R Markdown](#org7fb52d0):datacamp:
        8.  [RTutor](#org91204bd)
        9.  [Interactive Tutorials for R](#orgee45931):R:learnr:
        10. [Markdown + XMInd (Blog)](#orge37dd4f)
        11. [How I teach R Markdown 29.5.2020](#orgd8b4339)
        12. [Making slides with xaringan 16.1.2019](#org30713dc)
        13. [R Markdown Tutorial (Video 2018, 8 min)](#orgbb0271d)
        14. [Advantages of Using R Notebooks For Data Analysis Instead of Jupyter Notebooks (6.6.17)](#org6dde3bd)
        15. [Markdown Tutorial](#org45d97f8)
        16. [Pimp my RMD: a few tips for R Markdown by Yan Holtz - 10 December 2018](#orga705e0d)
        17. [Bookdown - R Markup](#org7b9343b)
        18. [R Markdown from R Studio](#orgea49165)
    12. [learnr](#org29f0942)
        1.  [Teaching in learnr](#org271724d)
        2.  [Publishing learnr Tutorials on shinyapps.io](#orgaef97d8)
8.  [Emacs / ESS](#org4da86f2)
9.  [Teaching - other courses and ideas](#org85059f4)
    1.  [R for Journalists (tutorial)](#orge4ac75b)
    2.  [Learning guide: Introduction to R, one-day workshop](#org91f82e4)
    3.  [STAT 220 labs Amelia McNamara](#orgc59c66d)
    4.  [A fresh look at introductory data science (paper 2020)](#org8e25964)
    5.  [Data science in a box (tidyverse, learnr)](#org6ffb91a)
    6.  [DS112 tutorials (net apps, learnR and GitHub exercises)](#orga42ad27)
        1.  [R Basics](#org25cc782)
        2.  [ggplot() and dplyr tutorial](#orge76304d)
    7.  [Teaching Statistics with R](#org00d5f10)
    8.  [Future of Statistical Programming](#org7119645)
    9.  [Bridging the Gap Between Tools for Learning and for Doing Statistics](#orgb42b0b6)
    10. [Codementor](#org500fb91)
    11. [Online course: Adventures in R](#org5b68b47)
    12. [Proposal for an educational data science course](#orgd0f9e88)
    13. [R Studio Cloud Primers](#orgd74bdbc)
    14. [How I Taught Scientific Blogging with R Markdown, Online](#org33468f2)
    15. [RStudio Instructor Certification Exams](#orga365397)
    16. [Market analysis course (interactive, free, and with a lot of R)](#orgf6d0057)
    17. [R for Bio Data Science (DTU Wiki)](#org3bac753)
    18. [Data science for biologists (playlist youtube)](#org02ff77a)
    19. [A novice’s guide to learning to code with CS50](#orgb144b44)
    20. [Introduction to SQL (Coursera)](#orgb3e59eb)
    21. [Syllabus](#orgd2c923d)
    22. [Mismatch Between Academic and Real-world Data Science Projects](#org83f2944)
    23. [UC Berkeley Connector Courses](#org4a40f38)
    24. [John DeNero | YouTube |  Intro Foundations of Data Science Intro | Online Book](#orgfedd67b)
    25. [Computational and inferential thinking | Online book](#orgcf5463f)
    26. [Data 8 - The foundations of data science (UC Berkeley) | Site: data8.org | Spring 2020 syllabus](#org6dc7d66)
    27. [Harvard edX Program](#org0c320d3)
    28. [Heidi Seibold | video 55 min |  presentation](#orge79a1ce)
    29. [The Johns Hopkins Data Science Lab](#org813b4ad)
10. [Data wrangling](#org191618e)
    1.  [Cleaning ecological survey data for conservation scientists](#orgd4af285)
    2.  [Cleaning messy data with tidyverse](#org026b895)
    3.  [Data Cleaning and Exploratory Analysis in Python and R](#orga09e7cb)
    4.  [Beyond Ordinary PCA: Nonlinear Principal Component Analysis](#org200c7f6):medium:
11. [Git/Github](#orgde5a470)
    1.  [Happy Git and GitHub for the useR (bookdown)](#org2ae210c)
    2.  [Git Emacs integration](#org6dbdfdc)
    3.  [How to upload your R code on GitHub: example with an R script on MacOS](#org63f56c1)
    4.  [The State of the Octoverse](#orgd5302cd)
    5.  [Building a blog using github and jekyll](#org99efc41)
    6.  [Using GitHub Actions for MLOps & Data Science](#org07b480d)
    7.  [BIRKENKRAHE @github](#org29ba3fd)
    8.  [Git Your SQL Together (with a Query Library)](#orga01a92d)
    9.  [Using GitHub Classroom to teach statistics (paper 2019)](#orga498cc7)
    10. [How to use Git and Github with R (15 min video)](#org9e677c4)
    11. [How to upload your R code on GitHub: example with an R script on MacOS (24.5.20)](#orgd0a8301)
    12. [Why You Should Blog with Hugo?An Introduction to the 'Blog with Hugo'](#org1c06980)
12. [Mixed Links](#org6f137e8)
13. [Math](#org5f7d6b0)
    1.  [Modeling](#org7b46e16)
        1.  [Tidy Modeling with R (Kuhn & Silge, 2020)](#org39e1872)
        2.  [Feature Engineering and Selection: A Practical Approach for Predictive Models](#org1a67f8b)
    2.  [ML](#orge53dc39)
        1.  [Math Companion to The Art of Machine Learning](#orgbfec31b):matloff:pdf:
    3.  [Stats](#org2c3a874)
        1.  [Daniela Witten's "Four Cardinal Rules of Statistics" (Tweets)](#orgc5e4b8d)
        2.  [The Lacking Wisdom of Crowds](#org144f0c1)
        3.  [Why Bayesian Stats Needs Monte-Carlo Methods](#orgea37baa)
        4.  [Introduction to Probability (2nd 3d) PDF](#org1b41091)
        5.  [A trick question for data science buffs](#org318be08)
        6.  [Descriptive vs Inferential Statistics in One Picture](#org0d97957)
        7.  [What the Null Hypothesis Really Means— According to a Statistics Professor](#orgd0ea468)
        8.  [P-values Explained By Data Scientist](#orge14af2e)
        9.  [How most statistical tests are linear models (with cheat sheet)](#org2838078)
        10. [What is p-value short for? (Kozyrkov)](#orgc668f4c)
        11. [The Magic of The Bell Curve (turn Python script into R)](#org572c94f)
        12. [Monte Carlo Simulation in R (see also Matloff 2020)](#org8e2279a)
        13. [Outliers detection in R](#org7bf13df)
        14. [Stop using p=0.05](#org251e4e9)
        15. [Essentially random isn't the same as actually random](#org1b51ab2)
    4.  [General maths](#orgb432d46)
        1.  [The Directed Edge Reinforced Random Walk: The Ant Mill Phenomenon](#org5fcb9fa)
        2.  [Understanding Mathematical Symbols with Code](#org8726581)
        3.  [A computational approach to the Prisoner’s Dilemma](#org2d126e5)
        4.  [What is Graph Theory, and why should you care?](#orgd3886dc)
        5.  [Matrices are Graphs (12 Aug 2020)](#org0c1c2ec)
        6.  [The Fastest Way to Compute the Fibonacci Sequence](#org16034f6)
        7.  [The Collatz Conjecture](#org9d090cb)
        8.  [The Riemann Hypothesis, explained](#orge9ad1ed)
        9.  [What is the determinant?](#org9ac85de)
        10. [A Tribute to Leonard Euler (youtube)](#org420c701)
        11. [Philosophy of Mathematics (Stanford Encyclopedia of Philosophy)](#orge95b422)
        12. [Introduction to Group Theory (see also book by Charles Pinter, kindle)](#org6f438cd)
        13. [Six Difficult Ways of Becoming a Millionaire by Francesco Di Lallo](#orgb115046)
        14. [The algebra and machine representation of statistical models (PhD)](#org513308c)
        15. [Mathematics for machine learning (book)](#orgc0b6672)
        16. [Statistics with R specialization @Coursera](#org47b5863)
        17. [Business statistics and analysis specialization @Coursera](#org0d0f225)
        18. [Statistics and probability in data science using Python](#org95105db)
        19. [Linear algebra: foundations to frontiers @edX](#org63e521b)
        20. [Mathematics for machine learning: linear algebra @Coursera](#orge0d5f3e)
        21. [Pre-university calculus @edX](#org6f9cdb7)
        22. [Calculus I @KhanAcademy](#orgcd508da)
        23. [Mathematics for machine learning: multivariable calculus  \* Discrete Mathematics <code>[0/8]</code>](#org2f04510)
        24. [Introduction to discrete mathematics for computer science specialization @Coursera](#orgfb76bc4)
        25. [Introduction to mathematical thinking @Coursera](#orgd875835)
        26. [Master discrete mathematics: sets, math logic, and more @Udemy](#orgad81fea)
        27. [Optimization methods in business analytics @edX](#orgcd6ac75)
        28. [Discrete optimization @Coursera](#org3cb136f)
        29. [Deterministic optimization @edX](#org4e01498)
14. [NN](#orge7a5c85)
    1.  [Artificial Neural Networks for Neuroscientists: A Primer](#org9b3f812)
    2.  [The Neural Network, A Visual Introduction | Visualizing Deep Learning](#orgde04601)
    3.  [RobustFill: Neural Program Learning under Noisy I/O (2017)](#org5839bec)
    4.  [Building a neural net from scratch using R (part 1, part 2)](#orge2ab337)
    5.  [The Beginner’s Glossary of Neural Network Terms](#org8de3950)
    6.  [Every Machine Learning Algorithm Can Be Represented as a Neural Network](#orgb9c118e)
    7.  [NN and ML vs Stats (culture wars)](#orgdefd572)
    8.  [BrainOS — The Most Brain-Like AI](#org66ef972)
    9.  [Understanding How Neural Networks Think](#orgca11217)
    10. [Can you remove 99% of a neural network without losing accuracy?](#orga9fe33a)
    11. [Symbolic Mathematics Finally Yields to Neural Networks](#org86814ba)
    12. [Explainable AI: Neural Networks (IBM)](#org207df22)
    13. [Why are neural networks so powerful?](#orgb795a0d)
    14. [22 articles about NN Jan 2019g](#orgaed2ad3)
15. [RStudio / IDEs / GUI](#org7ad62a0)
    1.  [GUIs and the Future of Work](#org38024e3)
    2.  [RStudio addins, or how to make your coding life easier](#org3f41537)
    3.  [Do, Share, Teach, and Learn Data Science with RStudio Cloud, Lou](#orgbaaaa62)
    4.  [A Dashboard of Shiny Apps by Andy Merlino 2020/07/17](#org2299646)
    5.  [keyboard shortcuts and tips and tricks](#org026b820)
    6.  [Using version control with RStudio](#orgf9af1aa)
    7.  [Interactive code with Shiny - Example](#orgf0dd9f0)
    8.  [Xaringan presentations](#org386581e)
    9.  [Connections window / database connections in RStudio](#org20b9049)
    10. [RStudio Primers (cloud) created using learnr (github)](#org5572621)
    11. [RStudio Blog](#org211e6c4)
16. [AI/ML](#org74b9a73)
    1.  [Self-Organizing Intelligent Matter: A blueprint for an AI generating algorithm](#org2643a28)
    2.  [R packages for eXplainable Artificial Intelligence](#org2c92583)
    3.  [A Beginner’s Guide To Computer Vision](#org2bc5673)
    4.  [How I Explained Word Embeddings To My Non-Technical Colleagues](#org8a97324)
    5.  [The Difference Between AI and Machine Learning (datacamp blog)](#org7a4def8)
    6.  [Supervised Machine Learning for Text Analysis in R](#org644cc18)
    7.  [What Types of Questions Can Data Science Answer?](#org4f19027)
    8.  [Deep AI engines example "How to become a data scientist in 30 days?"](#orgeda96ee)
    9.  [Game Theory for Data Scientists](#org2c3f345)
    10. [Facial Recognition Bans: What Do They Mean For AI (Artificial Intelligence)?](#orgcd972aa)
    11. [Core progress in AI has stalled in some fields 29.5.20](#org053a011)
    12. [The limits of knowledge - Gödel, Turing, and the science of what we can and cannot know](#org65c3890)
    13. [Computing Machinery and Intelligence (A M Turing 1950)](#org8a750ac)
    14. [What is the relevance of Gödel's theorem(s) to AI?](#orge4b656c)
    15. [Platonist Roger Penrose “Sees” Mathematical Truths (19 May 2020)](#orgcaabf4c)
    16. [The remarkable evolution of AI (5 May 2020)](#orge9b6c55)
    17. [IBM claims its Neural Computer achieves record AI model training time (14 May 2020)](#orga6fd1b8)
    18. [The computers of nature - Cellular automata and the emergence of computation in natural systems](#orga0ac9cb)
17. [SQL/(R)SQLite](#orgbec8792)
    1.  [How To Connect R With SQL (PostGreSQL)](#orgb21a305)
    2.  [How to Learn SQL (Datacamp blog)](#orgdfc21b4)
    3.  [Machine learning example with SQL only](#org3a882e2)
    4.  [Data Lakes vs. Data Warehouses](#org5be6758)
    5.  [Apache Spark, JDBC, sparklyr](#org7aca8db)
    6.  [R and ODBC – Pulling Data From A SQL Database](#orgd825b54)
    7.  [4 SQL Tips for Data Scientists and Data Engineers](#org00773ff)
    8.  [SQL equivalents in R](#org4f5f382)
    9.  [Building Complex SQL Queries with R](#org9218aed)
    10. [Ten SQL Concepts You Should Know for Data Science Interviews](#org088243d)
    11. [Linear Regression with SQL (whitepaper) & R Notebook](#org79eb38e)
    12. [Using SQL in RStudio (29.4.20)](#orgcc22263)
    13. [Appropriate uses for SQLite](#org6b3c08a)
    14. [Relational Algebra (tutorialspoint)](#org2cb3dec)
    15. [RSQLite](#orgd9db0a2):rsqlite:
        1.  [access in RStudio with the connections pane](#org6913f07)
        2.  [Read Data from an SQLite Database (video 8 min)](#orgf57a321)
        3.  [RSQLite = SQLite in R](#org560cde6)
        4.  [Beginners Guide to SQLite (in R)](#org6f0b512)
    16. [JSON (JavaScript Object Notation) Files](#org99e1022)
        1.  [RJSON package](#orgd9d4140)
        2.  [Tutorial: Working with Large Data Sets using Pandas and JSON in Python](#org6777880)
    17. [SQL Joins Grafik](#org6d197fb)
    18. [SQL Data Types (Mode)](#org447826e)
    19. [Crunchbase - data dashboard solution](#orgb73fc81)
    20. [SQL for Data Scientists, in Under 6 Minutes](#orgb530861)
    21. [SQL Case Study: Investigating a Drop in User Engagement](#org8d7a504)
    22. [SQL Case Study: Investigating a Drop in User Engagement (21 May 2020)](#org39ae8a2)
18. [NLP](#org0ce942e)
    1.  [State-of-the-art NLP models from R:](#org99076c4)
    2.  [A Guide to Text Annotation — the Key to Understanding Language](#org1f67e08)
    3.  [Datacamp: natural language processing in R](#org2203a94)
19. [Blockchain](#org308068c)
...
-   [covdata - COVID-19 specific case and mortality data](#orgad564fa)


<a id="orgfd3a3a3"></a>

### [Issues with the "flatten the curve" meme and chart? (FastCompany 13 March 2020)](#orgfd44a74)


<a id="org1e1aca7"></a>

### [COVID-19 cases in India drop every Sunday - how to explain?](#org15485ba)
...
## [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#orgf3d5d11)
...
### [Does the chart support the text? (COVID-19 and economic data)](#orgad437e4)
...
### [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#orgeb2c742)
...
## [The Goldilocks Principle - investing in stocks](#org8e809af) (beautiful graphs)
...
-   [Git Emacs integration](#org6dbdfdc)
...
### [Why Bayesian Stats Needs Monte-Carlo Methods](#orgd849354)
