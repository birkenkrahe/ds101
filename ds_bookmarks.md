...
1.  [Interesting applications](#org919c819)
    1.  [Building a visual CV in R](#org7427111)
    2.  [US 2020 Presidental Election and Rural - Urban Divide](#org8c8fa41)
    3.  [U.S. Food Deserts](#org814372c)
    4.  [Exploring My Spotify Listening](#orgfbb3bf8)
    5.  [EDA of a bank dataset (R programming series)](#org97da4f2)
    6.  [Run your own R analysis of people's Google searches](#org12bfe8f)
    7.  [Using the president’s tweets to understand political diversion in the age of social media](#org13edebe)
    8.  [Timelining the Trump presidency](#orgcdcfcea)
    9.  [Data-driven astronomy](#orga11bc5c)
    10. [Language Models are Open Knowledge Graphs (Paper Explained)](#org3b6c304)
    11. [American political data & R (31.10.2020)](#org0b1f456)
    12. [Space Shuttle disaster and linear regression model](#org7d61d98)
    13. [COVID-19](#org69a5553)
        1.  [120 years of US death CDC database](#orgb129238)
        2.  [Covid-19: The global crisis — in data](#org8d19727)
        3.  [Comparing COVID-19 to seasonal influenza (7 Oct 2020)](#orga3ca746)
        4.  [Paper: homogenous COVID-19 response (Sept 1, 2020)](#org67b0d85)
        5.  [Leading Causes of Mortality by U.S. County](#orgeef6d6a)
        6.  [Visualization of COVID-19 Cases in Arkansas](#org140e781)
        7.  [Excess Deaths by Cause](#org9ce086b)
        8.  [How to Assess Risks During the Coronavirus Pandemic](#org6dd619c)
        9.  [US Excess Mortality](#org83c1099)
        10. [Issues with the "flatten the curve" meme and chart? (FastCompany 13 March 2020)](#org323ba76)
        11. [COVID-19 cases in India drop every Sunday - how to explain?](#orgf079c56)
        12. [Severity Score Derivation](#org87cad3f)
        13. [Does the chart support the text? (COVID-19 and economic data)](#org823c9af)
        14. [Risk of catching a fatal case of COVID-19 is like having a bath (Sept 2020)](#org12a252f)
        15. [Twitter discussion example (June 2020)](#org465ce1f)
        16. [Micromort = one-in-a-million chance of death risk unit](#org1c4f04e)
        17. [Track COVID-19 Data Yourself with R](#org70a1c64)
        18. [How to Think Like an Epidemiologist (NYT, 4 Aug 2020)](#org8254a33)
        19. [covid19italy v0.3.0 is now on CRAN](#org3b8f042)
        20. [This Chart Predicts Which Colleges Will Survive the Coronavirus](#org6cb208c)
        21. [You’re Not Measuring COVID-19 Correctly](#org8e2986a)
        22. [Hands-on: How to build an interactive map in R-Shiny: An example for the COVID-19 Dashboard](#orgcb89594)
        23. [Data Mining COVID-19 Epidemics with Orange](#orgcd19a11)
    14. [Sentiment Analysis in R with Custom Lexicon Dictionary using tidytext](#orgc21b0c3)
    15. [Five Factors Across the Business Cycle](#orgc257d46)
    16. [Automation tips](#org2f8eb7d)
        1.  [Everything I Automated In 2020 To Save Me Hours Of Time](#orgbe547f3)
        2.  [How to Automate PDF Reporting with R](#org490c529)
        3.  [How to Automate Excel with R](#org54bb3d5)
    17. [Why R? Text Mining Hackathon Summary](#orgfb03a0b)
    18. [tayloR (22 Jul 2018)](#orgefb2871)
    19. [What Matters in Speed Dating?](#org22d61ef)
    20. [Science as Amateur Development (YouTube R McElreath) / p-hacking etbc.](#org8e44a41)
    21. [How to scrape WORD documents in R](#org69f8c5a)
    22. [Using Drake for ETL - Building A Shiny Real Estate App](#orgb81e146)
    23. [Support for protests&#x2026;compassion fatigue? (June vs Sept 2020)](#orgd549abf)
    24. [Tracking historical changes in trustworthiness](#orgc3687e2)
    25. [Exploring 30 years of local CT weather history with R](#org604b1b7)
    26. [R for Excel users](#org33000c3)
    27. [How to Automate PowerPoint Slidedecks with R](#org478a754)
    28. [100 Time Series Data Mining Questions (with answers!) part 1-3](#org54ebfd3)
    29. [Nobel-prize winners for Biden](#org74d01f0)
    30. [Officer R package - manipulate Word and PPT documents](#orge40a9bc)
    31. [Have R Look After Your Stocks!](#org5cc4d9f)
    32. [Analysing campaign contributions (2018-2020)](#org41f666d)
    33. [R for Health Data Science (book)](#org013bc4c)
    34. [Movie recommender system (DS portfolio) with Tableau (Medium blog post)](#orgdf69d02)
    35. [Hegel vs Nietzsche NLP](#orgaee54ba)
    36. [Star Wars Fandom Survey](#org2d66adf)
    37. [Genomic data science (coursera)](#org8e21118)
    38. [Introduction to survival analysis (customer churn/retention)](#orgb3cd46e)
    39. [Tidy Tuesday live screencast: Analyzing European energy in R](#org414bbdb)
    40. [Sharing pictures from holidays in the Canadian Rockies (with R)](#orgaeb8621)
    41. [The Goldilocks Principle - investing in stocks](#org48f6ed2)
    42. [Customer Churn – Logistic Regression with R (2017)](#org42a6877)
    43. [Twitter text analysis: The Most Popular Towards Data Science Article Topics on Twitter](#org85b5d60)
    44. [Labor force growth by decade (plot)](#orgc506584)
    45. [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#org6bcd98c)
    46. [Earthquake early warning system](#org188fd87):node:red:ibm:
    47. [International Space Station](#org25a5a92)
    48. [Credit Risk Modelling using Machine Learning using R](#orgf7856f3)
    49. [How to create a timeline of your CV in R?](#org498c672)
    50. [Crime by the numbers (R for criminologists)](#org5472b4e)
    51. [Qualitative Data Science: Using RQDA to analyse interviews](#orgebed3de)
    52. [Discourse Network Analysis: Undertaking Literature Reviews in R](#orgeb52e6a)
    53. [Movement data in GIS](#org8459cd6)
    54. [Complex societies precede moralizing gods throughout world history](#org5e1f750)
    55. [Brownian motion](#orgfe3997c)
        1.  [Simulating Brownian Motion in R](#org583e903)
    56. [The rise of the Netflix hit](#org293d2e1)
    57. [Google teaches ML to journalists](#org3161de8)
    58. [Guide to Classification on Imbalanced Datasets](#org2550465)
    59. [Automatically create draw.io diagrams from CSV files](#orgcd20115)
    60. [How to Build a Video Game in R Shiny with CSS, JavaScript, and R6 Classes](#org673d505)
    61. [Pacific Island Hopping using R and the iGraph package](#org50f9ef6)
    62. [Website building: Export WordPress to Hugo Markdown or Org Mode with R](#org86c266a)
    63. [A Complete Introduction to Apache Airflow (automating workflows)](#org6b1fb18)
    64. [RTutor: Quantifying Social Spillovers in Movie Ticket Sales](#orgfbb45a0)
    65. [Build a Chatbot with R](#org07a8392)
    66. [Dataquest data science projects](#org40537cc)
    67. [Experiences Building a Production Shiny App for Mobile](#orge7dda65)
    68. [17 classification algorithms using R](#org30cb497)
    69. [Comet - ds and ml wrapper](#org2d19650)
    70. [ISING Model (Quanta Mag)](#org8baa69b)
    71. [Social network analysis with igraph (tutorial)](#org2643dc8)
    72. [Riddles](#org0273829)
    73. [Games](#orgace18d0)
2.  [Careers](#orgf406087)
    1.  [Getting to know the Kaggle Grandmasters (youTube playlist)](#orgf2e9e29)
    2.  [datacamp - The L&D Guide to Data Fluency](#org79ad3cf):ATTACH:
    3.  [How Much is a Data Scientist Worth in 2020?](#orge74a8b3)
    4.  [Podcast "A career in data science"](#orga1425c4)
    5.  [How You Should Change Your Data Science Education](#org9a6582e)
    6.  [Professional Machine Learning Engineer (Google)](#org7b3199b)
    7.  [50 Questions to Test True Data Science Knowledge](#org7a5d051)
    8.  [Data Science questions](#org7fdd575)
    9.  [Data Scientist’s 2020 Toolbox: A List of Tools to Increase Your Productivity](#orgcba8862)
    10. [Some Important Data Science Tools that aren’t Python, R, SQL or Math](#orge6793ca)
    11. [The Essential Skills Most Data Science Courses Won’t Teach You](#orgab25553)
    12. [Top 9 Data Science Careers of the Future](#orgd0c5c56)
    13. [Data Science’s Most Misunderstood Hero](#org5210bb0)
    14. [Data Science Concepts Explained to a Five-year-old](#orgf81fac8)
    15. [I Worked Through 500+ Data Science Interview Questionsg](#org597380f)
    16. [Business Analytics vs Data Analytics in One Picture](#org6d35a6d)
    17. [The Role of the Data Scientist](#org605de7a)
    18. [How a Biologist Became a Data Scientist](#org2535ffa)
    19. [Data science pioneers (movie, 60 min, 2020)](#orge5aa449)
    20. [Curiosity-Driven Data Science (27 Nov 2018)](#org8e67410)
    21. [66 job interview questions for data scientists (13.2.2013)](#org966c5f1)
    22. [Data science workflow: Overview and Challenge (Philip Guo 10/2013)](#orgd62ccb8)
    23. [Twelve Tips for Data-Driven Research (Philip Guo, Nov 2015)](#org5f8f0fd)
    24. [Data Scientist: The Sexiest Job of the 21st Century (HBR 10/2012)](#org3c8d233)
    25. [What Data Scientists Really Do, According to 35 Data Scientists (HBR 15.8.2018)](#orge9e4a32)
    26. [Discover data science - How to become a data scientist (programs)](#org85a533e)
    27. [Data Scientist: The Dirtiest Job of the 21st Century (20.2.20)](#orge195135)
    28. [How I went from zero coding skills to data scientist in 6 months (2020)](#orgccbd25c)
    29. [How I Would Learn Data Science (If I Had to Start Over) (2020)](#org637619e)
    30. [How To Learn Data Science If You’re Broke (2018)](#org60bce8c)
    31. [If I had to start learning Data Science again, how would I do it? (2020)](#orgfd21cce)
    32. [Yes, You Can Become a Data Scientist Online. Here’s How. (19.5.20)](#org0d5b8ec)
3.  [R](#org1194f2b)
    1.  [Packages](#org806b0f3)
        1.  [A `ggplot2` tutorial for beautiful plotting in R (2020-12-07))](#orgc48313c)
        2.  [R Packages: A Beginner's Guide](#orge152295)
        3.  [Your first R package in 1 hour](#orgf097112)
        4.  [data.table](#org03a76a8)
        5.  [Tidyverse](#orgbdd795d)
        6.  [uspols: A collection of US political data](#orgf03905d)
        7.  [`sauron` package for convolutional neural networks](#orgc8e0d71)
        8.  [gt for tables](#org11104c1)
        9.  [Rolling Averages with {slider} and Covid Data (Oct 2020)](#orga993c2f)
        10. [Package for colorblind plots](#org5584dac)
        11. [feedeR: Reading RSS and Atom Feeds from R](#orgfcf9ebb)
        12. [Reinstall missing LaTeX packages with TinyTex](#org5be4ba9)
        13. [lessr](#org74fe9b6)
        14. [How to simplify your code by using data flows](#org507274c)
        15. [What to do when R tells you it can't install a package](#orgc0a6e5e)
        16. [Fodil's many packages (utilities/presentation)](#orgeee0e00)
        17. [covdata - COVID-19 specific case and mortality data](#org9c68525)
        18. [How to Explore Data: {DataExplorer} Package](#org0e7a66f)
        19. [Tidytable: tidyverse functions with data.table speed](#orgcd3c1b9)
        20. [Text mining with R and quanteda](#org63cccf8)
        21. [renv - Why Package & Environment Management](#orgda6a153)
        22. [Introduction to the DataRobot R Package](#org4805f23)
        23. [library() vs package vs ls() vs vignette](#org0a90b55)
        24. [Package leaderboard & book](#orgdbce0aa)
    2.  [R vs Python](#org7f55287)
        1.  [Choosing Python or R for Data Analysis? An Infographic](#orgb9761c0)
        2.  [Python vs. R: A Text Mining Approach for analyzing the Research Trends in Scopus Database](#org49ff8bc)
        3.  [Trying R for the First Time](#org6c8aff7)
        4.  [Debunking R and Python Myths: Answering Your Questions](#orgb7f9a67)
        5.  [How R still outperforms Python](#orgcc08936)
    3.  [How to Write an R Function to Match and Merge 2 Files (like VLOOKUP)](#org565c820)
    4.  [My Year in R (Oct 15, 2020)](#orgd3c36cc)
    5.  [Little useless-useful R function](#org38bf7e1)
    6.  [The evolution of distributed programming in R](#org41e52c3)
    7.  [Hack: How To Convert All Character Variables To Factors](#org7ac83ef)
    8.  [How To Get Data From Different Sources In R](#org5c718bf)
    9.  [Apply family functions - Part 1](#orgbac58e7)
    10. [The Fastest Way To Read And Write Files In R](#orge2b55d9)
    11. [Finding factorials](#org2083a81)
    12. [Data manipulation in r using data frames - an extensive article of basics](#orgb0c968b)
    13. [How to Extract Day from Datetime in R with Examples](#orgdb8a5e1)
    14. [How to subset a data frame column data in R](#org9cdc4b8)
    15. [Common R error messages](#orgc8ccc1e)
    16. [A Guide to the Pipe in R](#org73de7a6)
    17. [Visualize as flow diagrams](#org9fa1ac7)
    18. [Demonstrating the central limit theorem in R](#org805182e)
    19. [R & RStudio - The Interoperability Environment for Data Analytics](#org6994bf0)
    20. [First sample sessions (R documentation)](#org78ce159)
    21. [metR - meteorogical (tidy) data package](#org9fbf318)
    22. [How to evaluate R Packages](#org4876b0b)
    23. [R Style guides](#org41532a3)
        1.  [R code style guide richie cotton](#org1d6e226)
        2.  [R-Style-Guide &#x2013; Towards a Goal of RED Code (Matloff 2019)](#org1374d10)
        3.  [R Style guide (jean)](#org3b627e1)
        4.  [Google’s R Style Guide](#org63af0cd)
        5.  [Bioconductor (bioinformatics)](#org7eaedd0)
    24. [Working with text in R (presentation)](#org4bc26a7)
    25. [doubleheadR (surveymonkey data analysis)](#org812b5ee)
    26. [magrittr - pipeline library](#org12d5541)
        1.  [compound assignment operator `%<>%`](#org08413b4)
    27. [Functional Programming in R with purrr](#org4f3e3b2)
    28. [Few things I learned while writing an R package](#org5cc1632)
    29. [Unit Testing in R](#orga3f13ee)
    30. [Building a collection of Hello World functions in R](#org72ac412)
    31. [Build a Corporate R Package for Pleasure and Profit by Brad Lindblad, Mar 5, 2019](#org552061c)
    32. [Doing Maths Symbolically: R as a Computer Algebra System (CAS)](#org1617dc9)
    33. [Five Tidyverse Tricks You May Not Know About](#orgc6306ca)
    34. [How to write your own R package and publish it on CRAN](#org80129e2)
    35. [Setting up your R environment (webinar w/Richie Cotton)](#org3eb39c0)
    36. [R Coding Style Guide](#org307ceb8)
    37. [Installing R 4.0 under Ubuntu 18.04](#org5787472)
    38. [Text Mining with R (bookdown)](#org5862241)
    39. [causaloptim: An Interface to Specify Causal Graphs and Compute Bounds on Causal Effects](#org2eaa1bc)
    40. [Machine learning using H2O](#orge242570)
    41. [Learning R With Education Datasets](#org8be582e)
    42. [Select first or last rows of a data frame](#orgbf851c3)
    43. [Good coding style (Wickham, Advanced R)](#orgdc98d19)
    44. [formatr: Format code automatically (Yhui Yie, 2019)](#orgd76f477)
    45. [Performance Optimization in R: Parallel Computing and Rcpp](#org484ecd7)
    46. [R Exercisesp](#orgba3f1db)
    47. [R Programming 101 (YouTube Playlist Data Professor)](#orgb174f8d):R:RStudio:
    48. [Testing statistical packages in R](#orgff74f5a)
    49. [Ten more random useful things in R you may not know about](#orgad174cc)
    50. [Onboard Help System: help.start()](#org5676068)
    51. [How to do more with R (playlist)](#orgc615dce)
    52. [The Seven Key Things You Need To Know About dplyr 1.0.0](#orgae8277c)
    53. [A Year in Review of R Programming 2019](#orgb629aaa)
    54. [R Programming Pundits (Telegram channel) - free tutorials](#orge97678c)
    55. [Programming with R (online tutorial)](#org95605cd)
    56. [Introduction to R and RStudio (online tutorial)](#orgabe7dd6)
    57. [R for Data Science (book, 2017)](#org85897e2)
    58. [Vlog by Philip Guo on the R ecosystem and R for Data Science - 5 Feb 2018](#org513b558)
    59. [Ten Time-Saving R Hacks (27.2.20)](#org6d9deef)
    60. [Textmining with R (book - 2014)](#orgfb39e3c)
    61. [Geocomputation with R (book - 2018)](#org757478c)
    62. [Build interactive tutorials with learnr (2020)](#orgb5f11fc)
    63. [Example: setting up R, RStudio, tidyverse R package](#org491ea42)
    64. [R and Jupyter Notebook](#org944de58)
    65. [Datacamp blog (30 Nov 2016)](#org607c667)
4.  [Datasets](#org5f406d7)
    1.  [How To Download Data From Google Analytics](#orgebdd032)
    2.  [Dark chocolate (Kaggle)](#org5e8026a)
    3.  [Searching medRxiv and bioRxiv Preprint Data](#org85d1096)
    4.  [Every Place I’ve Gotten Data For Data Science Projects, Rated](#org10dc22b)
    5.  [Useful sites for finding datasets for Data Analysis tasks](#org33fec6f)
    6.  [CDC vital statistics](#org26336e3)
    7.  [satellite data](#orgf960a43)
    8.  [Unsplash’s dataset is now open source](#orgb53735a)
    9.  [Google dataset search](#org3b3a80c)
    10. [HWR Datenbanken](#orgaa466fc)
    11. [Penguins Dataset Overview - iris alternative in R](#org7b0c1ef)
    12. [Cleaning Data in R (datacamp course) - case studies](#org60b2d9a)
    13. [Importing data in R (datacamp course)](#org3fb9453)
    14. [Google datasets](#orgd226008)
    15. [How to Collect Data for Your Analysis (June 6, 2020)](#org5e5fb15)
    16. [data.gov.uk](#orgf4d5fa3)
    17. [17 Free Financial & Economic Datasets for Machine Learning](#orgf6c7d4d)
    18. [AWS Open Datasets](#org3249346)
    19. [Amazon Customer Reviews](#org56a0e51)
    20. [Getting Started With SpaceNet Data](#org0f0e8ad)
    21. [18 Places to Find Free Data Sets for Data Science Projects](#orgd5f6dea)
    22. [Andrew Heiss' collection (political science)](#org6514b14)
    23. [COVID-19 Data Hub](#org70108d8)
    24. [R built in Data Sets](#org894275b)
    25. [19 Free Public Data Sets for Your Data Science Project](#org2ae66a5)
    26. [US Census Bureau - Employment data](#org8bf7637)
    27. [dslabs (HarvardX)](#orgc29949a)
    28. [Learning R on iris (2016)](#orga94fe73)
5.  [Blogs worth reading](#org7bc71ad)
    1.  [dataENQ - financials series](#orgf4d495d)
    2.  [Judeah Pearl](#org0f353df)
    3.  [Will Kurt Count Bayesie](#org00aa24c)
        1.  [Why Bayesian Stats Needs Monte-Carlo Methods](#org6e9eb8d)
    4.  [“One Year of Data Science Blogging — Was it Worth it?”](#org67cbb50)
    5.  [Data Science is a Science (Just Not the One You May Think)](#org76df36e)
    6.  [Megan Stodel](#orgc20da09)
    7.  [Anita Graser](#org894d859)
    8.  [pete werner - Density plots in ggplot](#orgd4a2355)
    9.  [Corey Sparks R blog (demographic modeling - cluster analysis)](#org8d20f49)
    10. [Quantum jitter](#orgee5c185)
    11. [Richie Cotton 4D Pie Charts](#org45ec442)
    12. [Martin Johnsson's blog about genetics](#org1ab9bd9)
    13. [Guest blogging R-posts.com](#org7c51ed8)
    14. [Mathew Analytics (e.g. R code review)](#orge015779)
    15. [Statistical modeling, causal inferene, and social science](#org5f21305)
    16. [R Rendering - Tylermw](#org217b633)
    17. [Sebastian Kranz](#org2433441)
    18. [18 great blog posts from 2016](#orgc400e4a)
    19. [List of top data science blogs 2020 (via Hi! I am Nagdev)](#orgac950ac)
    20. [Joshua Cook - Riddler](#org76a5598)
    21. [R-Bloggers](#org389330d)
    22. [Radford Neal - COVID-19](#orgc649850)
    23. [Holker K. von Jouanne-Diedrich](#org37abeaa)
    24. [https://physicsgarage.com/](#org1a14437)
    25. [Publishable Stuff / Rasmus Baath](#orge04ab0c)
    26. [Xi'An's OG](#org6703591)
    27. [Radford Neal's blog](#orgd4dbb72)
    28. [Vicky Boykis](#org588b20a)
    29. [Markus Lang](#orgef30cb5)
    30. [Aerin Kim](#orgc90ef70)
    31. [Cassie Kozyrkov](#org0f204d8)
    32. [Tim Gowers](#org5e807d2)
    33. [RStudio Blog](#org7b56a4b)
    34. [RWeekly](#org4de939c)
6.  [Visualization](#orgba5ea40)
    1.  [A `ggplot2` tutorial for beautiful plotting in R (2020-12-07))](#org92634be)
    2.  ["Land doesn't vote, People do" (Twitter, Nov 2020)](#org28733d5)
    3.  [Whose Employees Have Donated to Biden vs. Trump](#org7c2b1b9)
    4.  [Upping your dataviz game (Claus O Wilke)](#orgf95259e)
    5.  [Data-GIF](#org0aab1e3)
    6.  [Animated GIF in Mathematica - turn into R?](#orgb65f800)
    7.  [R Programming for Beginners | The Ultimate Guide to GGPLOT2: Scatter Plots (video)](#org4bc6335)
    8.  [The Good, the Bad and the Ugly: how (not) to visualize data](#org49e7d39)
    9.  [Personal Art Map with R](#org5d2ccad)
    10. [Building an animation step-by-step with gganimate](#org5d78831)
    11. [TwoTone visualizing data with sound and music (Google)](#orgb46bfd1)
    12. [Visualizing Google Data (via trends.google.com)](#org582f8ca)
    13. [Finding the Shortest Path with Dijkstra’s Algorithm](#orgc1064c3)
    14. [Snap! visualization - pointillism](#orgb6e9e74)
    15. [A short tutorial for decent heat maps in R](#org0a67c60)
    16. [Challenges](#orgf7706c3)
        1.  [Problems with this graph? (UK covid development)](#org03d94d3)
        2.  [Does the chart support the text? (COVID-19 and economic data)](#org48422fd)
        3.  [Issues with the "flatten the curve" meme and chart? (FastCompany 13 March 2020)](#org1545445)
    17. [D3.js — How to Make a Beautiful Bar Chart With The Most Powerful Visualization Library](#orge97bdd3)
    18. [“What Data Visualisation Experts Wish They Knew When They First Started”](#org2a28738)
    19. [Tutorial: Plotting in R for Python Refugees](#org253f94f)
    20. [Microsoft Research: Expressive Pixels](#org6b24305)
    21. [Most popular on Netflix. Daily Tops for last 60 days](#org1e23c7e)
    22. [How dynamic is the browser market?](#org805f0a6)
    23. [Energy consumption in last 140 years](#org105a16e)
    24. [Gapminder](#orgbb4de4d)
        1.  [Visualization of 35 years of world’s economy evolving as a living organism](#orgc300063)
        2.  [How to build Animated Charts like Hans Rosling — doing it all in R](#org5ca2449)
        3.  [Exploring the Gapminder Data with R](#orgc71c655)
        4.  [Empfehlungen Roland Müller (Rosling pro and con):](#org2a09af8)
    25. [ggplot](#org2da92de)
    26. [Create a line graph with ggplot](#org961b7a7)
        1.  [Dataquest beginner's tutorial ggplot2](#org8f93473)
        2.  [Graphics in R with ggplot2](#orge60bd8f)
        3.  [ggplot2 easthetics cheat sheet](#orgb85241b)
        4.  [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#org911fda0)
        5.  [A ggplot2 Tutorial for Beautiful Plotting in R](#org26202dc)
        6.  [Tutorial: why data visualization is important (ggplot2)](#orgcfa7f54)
        7.  [Writing Functions to Automate Repetitive Plotting Tasks in ggplot2](#org22cc608)
        8.  [a ggplot2 grammar guide](#org6295ef2)
        9.  [Top 50 ggplot2 Visualizations - The Master List (with full R code)](#orgb141ab4)
        10. [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#orgc172766)
    27. [Abstractions - Physarum model visualizations](#org5d5d7a6)
    28. [You’re Plotting the Wrong Things](#org8b0dfa3)
    29. [Analytics is not storytelling (Kozyrkov](#orgbe7c096)
    30. [You Can Design a Good Chart with R](#org0a8dcef)
    31. [The Goldilocks Principle - investing in stocks (beautiful graphs)](#org7b128ec)
    32. [Embed Interactive Plots in Your Slides with Plotly](#org8bb40cf)
    33. [PowerPoint is evil (E Tufte, 9 Jan 1983)](#org0e91a22)
    34. [Cheesecake Diagrams: Pie Charts with a Different Flavour](#orgc4c4d50)
    35. [Demo: Create beautiful charts with Datawrapper](#org2bcfbb3)
    36. [A Comprehensive Guide to the Grammar of Graphics for Effective Visualization of Multi-dimensional Data](#org5d7d538)
    37. [Visualization examples](#org26282cc)
        1.  [Making Interactive Maps in R with Less Than 15 Lines of Code](#org2e3719a)
        2.  [Sqrt(2) puzzle animation](#orgb4f10cf)
        3.  [Power socket types Europe (Twitter account gesperrt!)](#orgb665d00)
        4.  [Size of Africa](#org2143e09)
    38. [fabricerin package to draw on shinyapp documents (?)](#org9d586ee)
    39. [The ultimate EDA visualization in R (raincloud plots)](#org0b0a973)
    40. [SpaceX Satellites Ruin Perfectly Good View of Comet NEOWISE](#orgccf6745)
    41. [Re-engineer graphs to extract the data (WebPlotDigitizer)](#orgb548a1c)
    42. [COVID-19 cases in India drop every Sunday - how to explain?](#org501837b)
    43. [Animated charts: visualizing “changes” in R](#orgbabe241)
    44. [Making Interactive Maps of Public Data in R by Ryan Rosenberg](#org944da43)
    45. [ggtext - formating text in graphs](#org9e75605)
    46. [A Layered Grammar of Graphics](#org23f4964)
    47. [My top 5 visualization tools for data science](#org09dd585)
    48. [Visualization good/bad examples](#orge2b6da5)
    49. [How to Visualize Data with R](#orga33c485)
    50. [Hadley Wickham: Managing many models with R (2016)](#org8d93b55):modeling:R:wickham:video:
    51. [Past project examples (Andrew Heiss)](#org07222e3)
    52. [R Visualizations David Gerbing 2020](#orgfa4cccf)
    53. [Online course in data visualization with R (May 2020) - Georgia State U / Dr Andrew Heiss](#org7e2b658)
    54. [Free book: Data Visualization with R (Rob Kabacoff, 2018)](#orgfab1bbf)
    55. [Free book: Data Visualization - A practical introduction](#orgeb78c72)
    56. [Free book: Fundamentals of Data Visualization by Claus O Wilke](#orgb8be558)
    57. [Easy Ways to Make Your Charts Look More Professional 28 May 2020](#orgce08b6f)
    58. [Stacked Bar Graphs, Why and How 28 May 2020](#orgba982cd)
    59. [Effective Visualizations for Credible, Data-Driven Decision Making (16.4.20)](#orgdf3011b)
    60. [Visualisation example: Data Privacy in the Age of Big Data](#org4ce8eeb)
    61. [Practical Implications of Sharing Data: A Primer on Data Privacy,](#orgdc95462)
7.  [RMarkdown / R Notebook / learnr / RTutor / OER](#org64046f5)
    1.  [Twitter: R Markdown tips list](#org1d5660d)
    2.  [glosario](#org95d7c92)
    3.  [Tableau vs. R Shiny: Which Excel Alternative Is Right For You?](#org3b04c05)
    4.  [From R to WordPress in two easy steps](#orgefc61ec)
    5.  [Image clipper into RStudio (add-in)](#org3f155ef)
    6.  [Getting started with R and RStudio (Dataquest tutorial)](#orgce832cd)
    7.  [Replacing PowerPoint with R](#orgced1abf)
    8.  ["Dashboards are dead" see also https://count.co](#org5feebb0)
    9.  [Interactive R tutorials with learnr (youtube)](#org2d23e10)
    10. [Tips and tricks in RStudio and R Markdown](#orgc829f43)
    11. [Jupyter Notebooks](#org78d7847)
    12. [Literate Programming](#org76861d0)
        1.  [Org-mode litprog in Emacs (2018) - long youtube video](#org317a61a)
        2.  [Configuring Emacs with Org mode and literate programming](#org698fd8a)
        3.  [Interview with Donald Knuth (1993) - LitProg, CWEB](#org98c2c73)
        4.  [Stanford page on LitProg](#org8b4a6d1)
        5.  [LitProg article by Knuth 1984](#orgdab80ca)
        6.  [The CWEB System of Structured Documentation (1993-2001)](#orgedb7513)
        7.  [LitProg - Propaganda and Tools (Christopher Lee 1994)](#orgd383bce)
    13. [DS in education](#org364975d)
        1.  [Open-Source Authorship of Data Science in Education Using R,](#orgb19f9f6)
    14. [R Markdown](#org794227b)
        1.  [Converting LaTeX to Bookdown (accessible lecture notes)](#org838e85b)
        2.  [How R Markdown changed my life (video 23 min)](#org1344728)
        3.  [Meta RMarkdown - Taxonomy and Use cases](#org4f9e203)
        4.  [Useful YAML options for generating HTML reports in R](#org82caa04)
        5.  [R Markdown Crash course (bookdown)](#orge10be76)
        6.  [Book: Practical R for Mass Communication and Journalism](#orgcfe9ec4)
        7.  [Course: Datacamp course R Markdown](#orgaac98ef):datacamp:
        8.  [RTutor](#orgdc47d57)
        9.  [Interactive Tutorials for R](#org72ca5b1):R:learnr:
        10. [Markdown + XMInd (Blog)](#org4225f42)
        11. [How I teach R Markdown 29.5.2020](#orge22bc47)
        12. [Making slides with xaringan 16.1.2019](#org3959f5b)
        13. [R Markdown Tutorial (Video 2018, 8 min)](#org62cd926)
        14. [Advantages of Using R Notebooks For Data Analysis Instead of Jupyter Notebooks (6.6.17)](#org646af37)
        15. [Markdown Tutorial](#orgeddb4de)
        16. [Pimp my RMD: a few tips for R Markdown by Yan Holtz - 10 December 2018](#orgcfa9fbd)
        17. [Bookdown - R Markup](#org3fab0a5)
        18. [R Markdown from R Studio](#org7410d08)
    15. [learnr](#org8618c1b)
        1.  [Teaching in learnr](#org685d522)
        2.  [Publishing learnr Tutorials on shinyapps.io](#orgc87eb47)
8.  [Dashboards](#org88a104b)
    1.  [Power BI vs R Shiny](#orgf383408)
9.  [Emacs / ESS](#org7fd7d8a)
10. [Teaching - other courses and ideas](#orgf471cf8)
    1.  [R for Journalists (tutorial)](#org8e1230a)
    2.  [Learning guide: Introduction to R, one-day workshop](#org70dccf5)
    3.  [STAT 220 labs Amelia McNamara](#orgc3531b0)
    4.  [A fresh look at introductory data science (paper 2020)](#org7d3dc1a)
    5.  [Data science in a box (tidyverse, learnr)](#org8550faf)
    6.  [DS112 tutorials (net apps, learnR and GitHub exercises)](#org6f77fb9)
        1.  [R Basics](#orge1e2e92)
        2.  [ggplot() and dplyr tutorial](#org71f0f53)
    7.  [Teaching Statistics with R](#orgf1a8b13)
    8.  [Future of Statistical Programming](#orgdd33a76)
    9.  [Bridging the Gap Between Tools for Learning and for Doing Statistics](#orgd47af9d)
    10. [Codementor](#orgc1b8c99)
    11. [Online course: Adventures in R](#orga1a05a4)
    12. [Proposal for an educational data science course](#orgb14e857)
    13. [R Studio Cloud Primers](#org70539c4)
    14. [How I Taught Scientific Blogging with R Markdown, Online](#orgda3b5f8)
    15. [RStudio Instructor Certification Exams](#org8c08a61)
    16. [Market analysis course (interactive, free, and with a lot of R)](#org50d08e5)
    17. [R for Bio Data Science (DTU Wiki)](#orged290c2)
    18. [Data science for biologists (playlist youtube)](#org7505ebd)
    19. [A novice’s guide to learning to code with CS50](#org62e0075)
    20. [Introduction to SQL (Coursera)](#org4886102)
    21. [Syllabus](#orgbf87111)
    22. [Mismatch Between Academic and Real-world Data Science Projects](#orgbb5d975)
    23. [UC Berkeley Connector Courses](#orgca03288)
    24. [John DeNero | YouTube |  Intro Foundations of Data Science Intro | Online Book](#org1aab962)
    25. [Computational and inferential thinking | Online book](#org648eb80)
    26. [Data 8 - The foundations of data science (UC Berkeley) | Site: data8.org | Spring 2020 syllabus](#org90d769c)
    27. [Harvard edX Program](#org17b804b)
    28. [Heidi Seibold | video 55 min |  presentation](#orgc30da8e)
    29. [The Johns Hopkins Data Science Lab](#org8ea8bf4)
11. [Data wrangling](#orgbf46089)
    1.  [Cleaning ecological survey data for conservation scientists](#org8b78477)
    2.  [Cleaning messy data with tidyverse](#orgec66227)
    3.  [Data Cleaning and Exploratory Analysis in Python and R](#orge66aaed)
    4.  [Beyond Ordinary PCA: Nonlinear Principal Component Analysis](#org7dc66af):medium:
12. [Git/Github](#org1886ee0)
    1.  [Happy Git and GitHub for the useR (bookdown)](#org3c7af73)
    2.  [Git Emacs integration](#org7b49977)
    3.  [How to upload your R code on GitHub: example with an R script on MacOS](#org60aab15)
    4.  [The State of the Octoverse](#orgae68b98)
    5.  [Building a blog using github and jekyll](#org17fd105)
    6.  [Using GitHub Actions for MLOps & Data Science](#orgc9ce7a9)
    7.  [BIRKENKRAHE @github](#org54f276c)
    8.  [Git Your SQL Together (with a Query Library)](#org7e005bf)
    9.  [Using GitHub Classroom to teach statistics (paper 2019)](#orgd8d2dad)
    10. [How to use Git and Github with R (15 min video)](#orgc7115dc)
    11. [How to upload your R code on GitHub: example with an R script on MacOS (24.5.20)](#orgcec2556)
    12. [Why You Should Blog with Hugo?An Introduction to the 'Blog with Hugo'](#orgc36b595)
13. [Mixed Links](#orgabb8aed)
14. [Math](#orga958472)
    1.  [Modeling](#orgcc856a5)
        1.  [How to Build Random Forests in R (Step-by-Step)](#org46f2e59)
        2.  [Models vs. Markets: Forecasting the 2020 U.S. election](#org1eb703b)
        3.  [Democratizing data science](#org5bdfe1c)
        4.  [Tidy Modeling with R (Kuhn & Silge, 2020)](#org499724f)
        5.  [Feature Engineering and Selection: A Practical Approach for Predictive Models](#org6448d24)
    2.  [ML](#org64feed1)
        1.  [The notion of "double descent" (code and example)](#org88deae6)
        2.  [Math Companion to The Art of Machine Learning](#orgad807ae):matloff:pdf:
    3.  [Stats](#org64c5497)
        1.  [Bayesian Workflow](#org02ea43c)
        2.  [The Central Limit Theorem (CLT): From Perfect Symmetry to the Normal Distribution](#orged9693e)
        3.  [Basic Statistics Using Excel: t-tests, effect sizes, figures, tables, and reporting in manuscripts](#orgf1e7fcb)
        4.  [Bayesian Statistics using R, Python, and Stan](#org753694a)
        5.  [Daniela Witten's "Four Cardinal Rules of Statistics" (Tweets)](#orgfb6130d)
        6.  [The Lacking Wisdom of Crowds](#org2697784)
        7.  [Why Bayesian Stats Needs Monte-Carlo Methods](#org258055c)
        8.  [Introduction to Probability (2nd 3d) PDF](#org84b945a)
        9.  [A trick question for data science buffs](#org11330a7)
        10. [Descriptive vs Inferential Statistics in One Picture](#org04bd45a)
        11. [What the Null Hypothesis Really Means— According to a Statistics Professor](#orgf7d3fff)
        12. [P-values Explained By Data Scientist](#org7ca8beb)
        13. [How most statistical tests are linear models (with cheat sheet)](#org56a14f2)
        14. [What is p-value short for? (Kozyrkov)](#org06a7ae5)
        15. [The Magic of The Bell Curve (turn Python script into R)](#orge81228f)
        16. [Monte Carlo Simulation in R (see also Matloff 2020)](#org3ce1e0e)
        17. [Outliers detection in R](#org8467566)
        18. [Stop using p=0.05](#orgaaa9389)
        19. [Essentially random isn't the same as actually random](#orge615373)
    4.  [General maths](#orgf16bc02)
        1.  [The meaning of differentiation (calculus), 1910](#org58f61be)
        2.  [The Directed Edge Reinforced Random Walk: The Ant Mill Phenomenon](#org60b9775)
        3.  [Understanding Mathematical Symbols with Code](#org3d57566)
        4.  [A computational approach to the Prisoner’s Dilemma](#org021dd36)
        5.  [What is Graph Theory, and why should you care?](#orgae23f61)
        6.  [Matrices are Graphs (12 Aug 2020)](#org05aa06a)
        7.  [The Fastest Way to Compute the Fibonacci Sequence](#orga2cf8d5)
        8.  [The Collatz Conjecture](#org8e4c62e)
        9.  [The Riemann Hypothesis, explained](#org7f6cb8e)
        10. [What is the determinant?](#org948dcc9)
        11. [A Tribute to Leonard Euler (youtube)](#orge11ffa2)
        12. [Philosophy of Mathematics (Stanford Encyclopedia of Philosophy)](#orgac7eab2)
        13. [Introduction to Group Theory (see also book by Charles Pinter, kindle)](#org7f410e9)
        14. [Six Difficult Ways of Becoming a Millionaire by Francesco Di Lallo](#orgef940a5)
        15. [The algebra and machine representation of statistical models (PhD)](#org6e94c29)
        16. [Mathematics for machine learning (book)](#org57c429b)
        17. [Statistics with R specialization @Coursera](#org049b5cc)
        18. [Business statistics and analysis specialization @Coursera](#org96595e0)
        19. [Statistics and probability in data science using Python](#org7162d1b)
        20. [Linear algebra: foundations to frontiers @edX](#orgb6dcc94)
        21. [Mathematics for machine learning: linear algebra @Coursera](#org8dd86fd)
        22. [Pre-university calculus @edX](#org22d0884)
        23. [Calculus I @KhanAcademy](#org5531a2d)
        24. [Mathematics for machine learning: multivariable calculus  \* Discrete Mathematics <code>[0/8]</code>](#org0e5ca45)
        25. [Introduction to discrete mathematics for computer science specialization @Coursera](#org246a6d5)
        26. [Introduction to mathematical thinking @Coursera](#org16c7fa4)
        27. [Master discrete mathematics: sets, math logic, and more @Udemy](#org3d728fe)
        28. [Optimization methods in business analytics @edX](#org62338f7)
        29. [Discrete optimization @Coursera](#org9f8be9f)
        30. [Deterministic optimization @edX](#orga5c0839)
15. [NN](#orga8e51c8)
    1.  [Artificial Neural Networks for Neuroscientists: A Primer](#orge0f1a66)
    2.  [The Neural Network, A Visual Introduction | Visualizing Deep Learning](#org7f4a2f7)
    3.  [RobustFill: Neural Program Learning under Noisy I/O (2017)](#org86a328c)
    4.  [Building a neural net from scratch using R (part 1, part 2)](#org61b7538)
    5.  [The Beginner’s Glossary of Neural Network Terms](#org0c8dac3)
    6.  [Every Machine Learning Algorithm Can Be Represented as a Neural Network](#orgf25e25d)
    7.  [NN and ML vs Stats (culture wars)](#orgea5a4de)
    8.  [BrainOS — The Most Brain-Like AI](#orgb98e3b9)
    9.  [Understanding How Neural Networks Think](#orga64479c)
    10. [Can you remove 99% of a neural network without losing accuracy?](#orgd1e9684)
    11. [Symbolic Mathematics Finally Yields to Neural Networks](#org5e1f1f3)
    12. [Explainable AI: Neural Networks (IBM)](#org32a02c2)
    13. [Why are neural networks so powerful?](#orgc418b8c)
    14. [22 articles about NN Jan 2019g](#org6e9dbd8)
16. [RStudio / IDEs / GUI](#orgbdd8f4f)
    1.  [GUIs and the Future of Work](#orga156b7b)
    2.  [RStudio addins, or how to make your coding life easier](#org030cc8d)
    3.  [Do, Share, Teach, and Learn Data Science with RStudio Cloud, Lou](#org48652e4)
    4.  [A Dashboard of Shiny Apps by Andy Merlino 2020/07/17](#org970a225)
    5.  [keyboard shortcuts and tips and tricks](#org9b2d147)
    6.  [Using version control with RStudio](#org9b103f8)
    7.  [Interactive code with Shiny - Example](#orgdb2027f)
    8.  [Xaringan presentations](#org2ecd5bd)
    9.  [Connections window / database connections in RStudio](#orga7f9a11)
    10. [RStudio Primers (cloud) created using learnr (github)](#org3121ac6)
    11. [RStudio Blog](#org5f128ca)
17. [AI/ML](#org02fa1c7)
    1.  [Retraining Machine Learning Models in the Wake of COVID-19](#orge2949fe)
    2.  [The information theory of individuality (January 2020)](#org40313c0)
    3.  [Understanding Deep Learning: Challenges for Statistical Learning Theory (Video)](#orga4f045f)
    4.  [`sauron` package for convolutional neural networks](#orga6bee2b)
    5.  [Tensorflow](#orgf1b983d)
    6.  [Free course: Machine Learning for Intelligent Systems (Cornell U 2020)](#org78f75a8)
    7.  [Recreating Historical Streetscapes Using Deep Learning and Crowdsourcing](#org660d36b)
    8.  [CausalWorld: A Robotic Manipulation Benchmark for Causal Structure and Transfer Learning](#org026ce06)
    9.  [The 2020 data and AI landscape](#org1dae0b3)
    10. [Interpretable Machine Learning &#x2013; A Brief History, State-of-the-Art and Challenges](#orga2a93fd)
    11. [Classifying images with torch](#org06460d3)
    12. [Self-Organizing Intelligent Matter: A blueprint for an AI generating algorithm](#org18e41f3)
    13. [R packages for eXplainable Artificial Intelligence](#org5831856)
    14. [A Beginner’s Guide To Computer Vision](#org8582eda)
    15. [How I Explained Word Embeddings To My Non-Technical Colleagues](#org0c165ab)
    16. [The Difference Between AI and Machine Learning (datacamp blog)](#org249df03)
    17. [Supervised Machine Learning for Text Analysis in R](#org3d0f652)
    18. [What Types of Questions Can Data Science Answer?](#org9d65a2c)
    19. [Deep AI engines example "How to become a data scientist in 30 days?"](#org0529f44)
    20. [Game Theory for Data Scientists](#orga5645c1)
    21. [Facial Recognition Bans: What Do They Mean For AI (Artificial Intelligence)?](#orgeff9aad)
    22. [Core progress in AI has stalled in some fields 29.5.20](#org28d72cd)
    23. [The limits of knowledge - Gödel, Turing, and the science of what we can and cannot know](#org437ca15)
    24. [Computing Machinery and Intelligence (A M Turing 1950)](#orgf8281dd)
    25. [What is the relevance of Gödel's theorem(s) to AI?](#org6f1fa22)
    26. [Platonist Roger Penrose “Sees” Mathematical Truths (19 May 2020)](#orga350763)
    27. [The remarkable evolution of AI (5 May 2020)](#org2e8181d)
    28. [IBM claims its Neural Computer achieves record AI model training time (14 May 2020)](#org37a96d7)
    29. [The computers of nature - Cellular automata and the emergence of computation in natural systems](#orgc7d8701)
18. [SQL/(R)SQLite](#org7e3e4e9)
    1.  [Customer churn dataset with SQL examples (MySQL)](#org71d4b29)
    2.  [Intro to SQL at Kaggle w/Google BigQuery](#org58505af)
    3.  [Kickstarter SQL style guide](#org96f078d)
    4.  [How To Connect R With SQL (PostGreSQL)](#org26ba9d8)
    5.  [How to Learn SQL (Datacamp blog)](#orga9a41d7)
    6.  [Machine learning example with SQL only](#org2edab3f)
    7.  [Data Lakes vs. Data Warehouses](#orgf746bf1)
    8.  [Apache Spark, JDBC, sparklyr](#org0e5cbef)
    9.  [R and ODBC – Pulling Data From A SQL Database](#org2bdc391)
    10. [4 SQL Tips for Data Scientists and Data Engineers](#orgb1c5218)
    11. [SQL equivalents in R](#org508cb2a)
    12. [Building Complex SQL Queries with R](#orgf569b64)
    13. [Ten SQL Concepts You Should Know for Data Science Interviews](#org17424c4)
    14. [Linear Regression with SQL (whitepaper) & R Notebook](#org56a0388)
    15. [Using SQL in RStudio (29.4.20)](#org0c07c4e)
    16. [Appropriate uses for SQLite](#orgfa2926c)
    17. [Relational Algebra (tutorialspoint)](#org7be1f04)
    18. [RSQLite](#orge8cd19d):rsqlite:
        1.  [access in RStudio with the connections pane](#orgba9dc36)
        2.  [Read Data from an SQLite Database (video 8 min)](#org765aea3)
        3.  [RSQLite = SQLite in R](#org48bf0dd)
        4.  [Beginners Guide to SQLite (in R)](#org228d14d)
    19. [JSON (JavaScript Object Notation) Files](#org8cfef9c)
        1.  [RJSON package](#orge74946f)
        2.  [Tutorial: Working with Large Data Sets using Pandas and JSON in Python](#org8ca42f1)
    20. [SQL Joins Grafik](#org0046b29)
    21. [SQL Data Types (Mode)](#orgb91f743)
    22. [Crunchbase - data dashboard solution](#org0007fd5)
    23. [SQL for Data Scientists, in Under 6 Minutes](#org1b8421c)
    24. [SQL Case Study: Investigating a Drop in User Engagement](#org7822f46)
    25. [SQL Case Study: Investigating a Drop in User Engagement (21 May 2020)](#orge53d928)
19. [NLP](#org8a890a8)
    1.  [State-of-the-art NLP models from R:](#orgcf80f9f)
    2.  [A Guide to Text Annotation — the Key to Understanding Language](#orgf33d386)
    3.  [Datacamp: natural language processing in R](#org41b4fa4)
20. [Blockchain](#org58e0df0)
...
-   [uspols: A collection of US political data](#orgf03905d)
...
-   [covdata - COVID-19 specific case and mortality data](#org9c68525)


<a id="org323ba76"></a>

### [Issues with the "flatten the curve" meme and chart? (FastCompany 13 March 2020)](#org1545445)


<a id="orgf079c56"></a>

### [COVID-19 cases in India drop every Sunday - how to explain?](#org501837b)
...
## [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#org911fda0)
...
### READ [A `ggplot2` tutorial for beautiful plotting in R](https://cedricscherer.netlify.app/2019/08/05/a-ggplot2-tutorial-for-beautiful-plotting-in-r/) (2020-12-07))
...
8.  [Why you should use `vapply` in R](https://theautomatic.net/2020/10/20/why-you-should-use-vapply-in-r/)

9.  [Data cleaning and exploration with data.table](https://www.meganstodel.com/posts/using-data-table/)

    Megan Stodel, Jul 19, 2020

10. [Why I love data.table](https://eliocamp.github.io/codigo-r/en/2019/07/why-i-love-data-table/) (6 July 2019 by Elio Campitelli)
...
1.  [R as Geospatial Information System (tidyverse, sf package)](https://datascienceplus.com/r-as-gis-part-1-vector/)
...
2.  [How to Rename Factor Levels in R using levels() and dplyr](https://www.marsja.se/how-to-rename-factor-levels-in-r-dplyr/)

    by Erik Marsja | Nov 4, 2020

3.  [dbplyr 2](https://www.tidyverse.org/blog/2020/11/dbplyr-2-0-0/)
...
4.  [10 Must-Know Tidyverse Features!](https://www.business-science.io/code-tools/2020/10/15/must-know-tidyverse-features.html)

    Written by Jim Gruman on October 15, 2020

5.  [Tidy correlation tests in R](https://dominicroye.github.io/en/2019/tidy-correlation-tests-in-r/)
...
6.  [Hack: The “count(case when … else … end)” in dplyr](https://predictivehacks.com/hack-the-countcase-when-else-end-in-dplyr/)
...
7.  [New relocate() function](https://youtu.be/swm3smjU0RU)

8.  [Ten Up-To-Date Ways to do Common Data Tasks in R](https://towardsdatascience.com/ten-up-to-date-ways-to-do-common-data-tasks-in-r-4f15e56c92d)

    Stay up to date with these ten simple examples using a dataset of
    cute penguins

9.  [Missing value visualization with tidyverse in R](https://towardsdatascience.com/missing-value-visualization-with-tidyverse-in-r-a9b0fefd2246)
...
## [A `ggplot2` tutorial for beautiful plotting in R (2020-12-07))](#orgc48313c)
...
### [Does the chart support the text? (COVID-19 and economic data)](#org823c9af)
...
### [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#org6bcd98c)
...
## [The Goldilocks Principle - investing in stocks](#org48f6ed2) (beautiful graphs)
...
-   [Git Emacs integration](#org7b49977)
...
### [Why Bayesian Stats Needs Monte-Carlo Methods](#org6e9eb8d)
...
## [`sauron` package for convolutional neural networks](#orgc8e0d71)
