...
1.  [Interesting applications](#orgc964af4)
    1.  [COVID-19](#orgf9a4bd6)
        1.  [Visualization of COVID-19 Cases in Arkansas](#org59189ab)
        2.  [Excess Deaths by Cause](#orgf983687)
        3.  [How to Assess Risks During the Coronavirus Pandemic](#orgd807a69)
        4.  [US Excess Mortality](#org7685cc1)
        5.  [Issues with the "flatten the curve" meme and chart? (FastCompany 13 March 2020)](#org0e147b4)
        6.  [COVID-19 cases in India drop every Sunday - how to explain?](#orgf7cf89f)
        7.  [Severity Score Derivation](#orge8ac775)
        8.  [Does the chart support the text? (COVID-19 and economic data)](#orgaa0a3fe)
        9.  [Risk of catching a fatal case of COVID-19 is like having a bath (Sept 2020)](#orgf11adb3)
        10. [Twitter discussion example (June 2020)](#org2ad9cf4)
        11. [Micromort = one-in-a-million chance of death risk unit](#orgb637a07)
        12. [Track COVID-19 Data Yourself with R](#org1c67cfd)
        13. [How to Think Like an Epidemiologist (NYT, 4 Aug 2020)](#org88225e3)
        14. [covid19italy v0.3.0 is now on CRAN](#org41892ef)
        15. [This Chart Predicts Which Colleges Will Survive the Coronavirus](#org67ae2d4)
        16. [You’re Not Measuring COVID-19 Correctly](#org574b8d4)
        17. [Hands-on: How to build an interactive map in R-Shiny: An example for the COVID-19 Dashboard](#org9abac15)
        18. [Data Mining COVID-19 Epidemics with Orange](#org53ad259)
    2.  [Five Factors Across the Business Cycle](#orgadf7b14)
    3.  [Automation tips](#orgf88f5e0)
        1.  [How to Automate PDF Reporting with R](#org42c9611)
        2.  [How to Automate Excel with R](#org7e739c6)
    4.  [Why R? Text Mining Hackathon Summary](#org8a37f35)
    5.  [tayloR (22 Jul 2018)](#org47004ec)
    6.  [What Matters in Speed Dating?](#org2d6410c)
    7.  [Science as Amateur Development (YouTube R McElreath) / p-hacking etbc.](#orgc36aff7)
    8.  [How to scrape WORD documents in R](#org435aaf5)
    9.  [Using Drake for ETL - Building A Shiny Real Estate App](#org4a4f16a)
    10. [Support for protests&#x2026;compassion fatigue? (June vs Sept 2020)](#org1b1c256)
    11. [Tracking historical changes in trustworthiness](#orgffc007c)
    12. [Exploring 30 years of local CT weather history with R](#org06e3ace)
    13. [R for Excel users](#orga03fa12)
    14. [How to Automate PowerPoint Slidedecks with R](#org062511b)
    15. [100 Time Series Data Mining Questions (with answers!) part 1-3](#orgafc1c64)
    16. [Nobel-prize winners for Biden](#orga6627bb)
    17. [Officer R package - manipulate Word and PPT documents](#org6185941)
    18. [Have R Look After Your Stocks!](#orgad677e8)
    19. [Analysing campaign contributions (2018-2020)](#org55b9754)
    20. [R for Health Data Science (book)](#org6280797)
    21. [Movie recommender system (DS portfolio) with Tableau (Medium blog post)](#orgb106277)
    22. [Hegel vs Nietzsche NLP](#org746219d)
    23. [Star Wars Fandom Survey](#org872a8c1)
    24. [Genomic data science (coursera)](#org8cfb412)
    25. [Introduction to survival analysis (customer churn/retention)](#orgf35e2dc)
    26. [Tidy Tuesday live screencast: Analyzing European energy in R](#org711a8c2)
    27. [Sharing pictures from holidays in the Canadian Rockies (with R)](#org8fb3147)
    28. [The Goldilocks Principle - investing in stocks](#org65a560a)
    29. [Customer Churn – Logistic Regression with R (2017)](#org88c0239)
    30. [Twitter text analysis: The Most Popular Towards Data Science Article Topics on Twitter](#org5ba23f0)
    31. [Labor force growth by decade (plot)](#orgc4d4f50)
    32. [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#orgc6f5ea3)
    33. [Earthquake early warning system](#orgf9243d3):node:red:ibm:
    34. [International Space Station](#orgd2d68dc)
    35. [Credit Risk Modelling using Machine Learning using R](#org6582af3)
    36. [How to create a timeline of your CV in R?](#org9758a69)
    37. [Crime by the numbers (R for criminologists)](#orgf6a83d2)
    38. [Qualitative Data Science: Using RQDA to analyse interviews](#org43a41b1)
    39. [Discourse Network Analysis: Undertaking Literature Reviews in R](#org5e62b56)
    40. [Movement data in GIS](#org7bc28ef)
    41. [Complex societies precede moralizing gods throughout world history](#org82283e5)
    42. [Brownian motion](#org65d84cc)
        1.  [Simulating Brownian Motion in R](#org561ba09)
    43. [The rise of the Netflix hit](#org56c4ef7)
    44. [Google teaches ML to journalists](#orge6dce02)
    45. [Guide to Classification on Imbalanced Datasets](#orgd432436)
    46. [Automatically create draw.io diagrams from CSV files](#orgd2e9097)
    47. [How to Build a Video Game in R Shiny with CSS, JavaScript, and R6 Classes](#orgee42e69)
    48. [Pacific Island Hopping using R and the iGraph package](#org6574e08)
    49. [Website building: Export WordPress to Hugo Markdown or Org Mode with R](#org4e110e5)
    50. [A Complete Introduction to Apache Airflow (automating workflows)](#org697114e)
    51. [RTutor: Quantifying Social Spillovers in Movie Ticket Sales](#org99b2eee)
    52. [Build a Chatbot with R](#orgebf8e6f)
    53. [Dataquest data science projects](#org4fcc028)
    54. [Experiences Building a Production Shiny App for Mobile](#org8770f5c)
    55. [17 classification algorithms using R](#orgd25cc05)
    56. [Comet - ds and ml wrapper](#org488423c)
    57. [ISING Model (Quanta Mag)](#org224ceb5)
    58. [Social network analysis with igraph (tutorial)](#orge2d3a2f)
    59. [Riddles](#orga4f7aa5)
    60. [Games](#org080bbf9)
2.  [Careers](#org63656c7)
    1.  [datacamp - The L&D Guide to Data Fluency](#org8b63426):ATTACH:
    2.  [How Much is a Data Scientist Worth in 2020?](#org0cf2907)
    3.  [Podcast "A career in data science"](#org1b93b46)
    4.  [How You Should Change Your Data Science Education](#orga54aaa3)
    5.  [Professional Machine Learning Engineer (Google)](#org2e794a7)
    6.  [50 Questions to Test True Data Science Knowledge](#orgc9b5a0b)
    7.  [Data Science questions](#org5209d1c)
    8.  [Data Scientist’s 2020 Toolbox: A List of Tools to Increase Your Productivity](#orge5d968c)
    9.  [Some Important Data Science Tools that aren’t Python, R, SQL or Math](#org8e8aeac)
    10. [The Essential Skills Most Data Science Courses Won’t Teach You](#orgcf83f22)
    11. [Top 9 Data Science Careers of the Future](#org50b888f)
    12. [Data Science’s Most Misunderstood Hero](#orgd069bb0)
    13. [Data Science Concepts Explained to a Five-year-old](#orgd3cec77)
    14. [I Worked Through 500+ Data Science Interview Questionsg](#orgd516369)
    15. [Business Analytics vs Data Analytics in One Picture](#org35b623c)
    16. [The Role of the Data Scientist](#org3ed8b9a)
    17. [How a Biologist Became a Data Scientist](#org18008ea)
    18. [Data science pioneers (movie, 60 min, 2020)](#orgfb044e8)
    19. [Curiosity-Driven Data Science (27 Nov 2018)](#org66e6e0f)
    20. [66 job interview questions for data scientists (13.2.2013)](#org4c5af06)
    21. [Data science workflow: Overview and Challenge (Philip Guo 10/2013)](#orgcac2d47)
    22. [Twelve Tips for Data-Driven Research (Philip Guo, Nov 2015)](#orgfbc70ae)
    23. [Data Scientist: The Sexiest Job of the 21st Century (HBR 10/2012)](#org383c521)
    24. [What Data Scientists Really Do, According to 35 Data Scientists (HBR 15.8.2018)](#org6105c56)
    25. [Discover data science - How to become a data scientist (programs)](#orgb2891a6)
    26. [Data Scientist: The Dirtiest Job of the 21st Century (20.2.20)](#org5eac46e)
    27. [How I went from zero coding skills to data scientist in 6 months (2020)](#orgb6c281d)
    28. [How I Would Learn Data Science (If I Had to Start Over) (2020)](#org76ee8b6)
    29. [How To Learn Data Science If You’re Broke (2018)](#org03606a9)
    30. [If I had to start learning Data Science again, how would I do it? (2020)](#org34fd70b)
    31. [Yes, You Can Become a Data Scientist Online. Here’s How. (19.5.20)](#orgfd4b892)
3.  [R](#orgf45a8fb)
    1.  [Packages](#org8b3b906)
        1.  [data.table](#org0bde555)
        2.  [tidyverse](#org53f61ee)
        3.  [Reinstall missing LaTeX packages with TinyTex](#orgbaadc57)
        4.  [lessr](#orgecceb51)
        5.  [How to simplify your code by using data flows](#orge2485e6)
        6.  [What to do when R tells you it can't install a package](#orgd171ed8)
        7.  [Fodil's many packages (utilities/presentation)](#orgc49d380)
        8.  [covdata - COVID-19 specific case and mortality data](#orgbabd94d)
        9.  [How to Explore Data: {DataExplorer} Package](#org4c8b9bf)
        10. [Tidytable: tidyverse functions with data.table speed](#org4ca9967)
        11. [Text mining with R and quanteda](#org1afb4d9)
        12. [renv - Why Package & Environment Management](#org308ce97)
        13. [R Packages: A Beginner's Guide](#orgf26a7a9)
        14. [Introduction to the DataRobot R Package](#org0880145)
        15. [library() vs package vs ls() vs vignette](#org2b59124)
        16. [Package leaderboard & book](#org8c7da18)
    2.  [R vs Python](#org403c8a0)
        1.  [Choosing Python or R for Data Analysis? An Infographic](#orgf0baac9)
        2.  [Python vs. R: A Text Mining Approach for analyzing the Research Trends in Scopus Database](#orgbd24a9f)
        3.  [Trying R for the First Time](#org14885dc)
        4.  [Debunking R and Python Myths: Answering Your Questions](#org04bbb71)
        5.  [How R still outperforms Python](#org9f11de3)
    3.  [Hack: How To Convert All Character Variables To Factors](#org4aad816)
    4.  [How To Get Data From Different Sources In R](#orgc6beac3)
    5.  [Apply family functions - Part 1](#org92e5f6d)
    6.  [The Fastest Way To Read And Write Files In R](#orgd2902c4)
    7.  [Finding factorials](#org5c259ac)
    8.  [Data manipulation in r using data frames - an extensive article of basics](#org9735cb1)
    9.  [How to Extract Day from Datetime in R with Examples](#org209807b)
    10. [How to subset a data frame column data in R](#org0825fbe)
    11. [Common R error messages](#org8be697b)
    12. [A Guide to the Pipe in R](#org6200964)
    13. [Visualize as flow diagrams](#org3b3abdf)
    14. [Demonstrating the central limit theorem in R](#org17ca0d9)
    15. [R & RStudio - The Interoperability Environment for Data Analytics](#orgdc82104)
    16. [First sample sessions (R documentation)](#orge7d7999)
    17. [metR - meteorogical (tidy) data package](#org6fc2730)
    18. [How to evaluate R Packages](#orgfa7a65e)
    19. [R Style guides](#org07f4023)
        1.  [R code style guide richie cotton](#org7a4d15b)
        2.  [R-Style-Guide &#x2013; Towards a Goal of RED Code (Matloff 2019)](#org15358a5)
        3.  [R Style guide (jean)](#orgacff5b5)
        4.  [Google’s R Style Guide](#org050dbf0)
        5.  [Bioconductor (bioinformatics)](#org59bc0b2)
    20. [Working with text in R (presentation)](#org061d0bd)
    21. [doubleheadR (surveymonkey data analysis)](#org0dfad89)
    22. [magrittr - pipeline library](#org843c052)
    23. [Functional Programming in R with purrr](#org8d6ad3d)
    24. [Few things I learned while writing an R package](#orgab9e1df)
    25. [Unit Testing in R](#org22d3e2d)
    26. [Building a collection of Hello World functions in R](#orgbe3d4ff)
    27. [Build a Corporate R Package for Pleasure and Profit by Brad Lindblad, Mar 5, 2019](#orga3879bb)
    28. [Doing Maths Symbolically: R as a Computer Algebra System (CAS)](#org6e22db4)
    29. [Five Tidyverse Tricks You May Not Know About](#org14076f1)
    30. [How to write your own R package and publish it on CRAN](#orgca4123d)
    31. [Setting up your R environment (webinar w/Richie Cotton)](#orgc5dec6c)
    32. [R Coding Style Guide](#orgc57056c)
    33. [Installing R 4.0 under Ubuntu 18.04](#orgedf10d3)
    34. [Text Mining with R (bookdown)](#org76f75d4)
    35. [causaloptim: An Interface to Specify Causal Graphs and Compute Bounds on Causal Effects](#orgd5c0eaf)
    36. [Machine learning using H2O](#org35a4dc8)
    37. [Learning R With Education Datasets](#org68abdd4)
    38. [Select first or last rows of a data frame](#orgfff5604)
    39. [Good coding style (Wickham, Advanced R)](#org0c73ab7)
    40. [formatr: Format code automatically (Yhui Yie, 2019)](#org61f25b9)
    41. [Performance Optimization in R: Parallel Computing and Rcpp](#org48278af)
    42. [R Exercises](#orgab0352e)
    43. [R Programming 101 (YouTube Playlist Data Professor)](#org92bb6ed):R:RStudio:
    44. [Testing statistical packages in R](#orgf502159)
    45. [Ten more random useful things in R you may not know about](#org3b838a0)
    46. [Onboard Help System: help.start()](#org8af31b6)
    47. [How to do more with R (playlist)](#orgd32efcd)
    48. [The Seven Key Things You Need To Know About dplyr 1.0.0](#org951be4b)
    49. [A Year in Review of R Programming 2019](#org5987bd4)
    50. [R Programming Pundits (Telegram channel) - free tutorials](#orge8b4d55)
    51. [Programming with R (online tutorial)](#org2ee2334)
    52. [Introduction to R and RStudio (online tutorial)](#org57ad7f7)
    53. [R for Data Science (book, 2017)](#org8f375f1)
    54. [Vlog by Philip Guo on the R ecosystem and R for Data Science - 5 Feb 2018](#org6adf0df)
    55. [Ten Time-Saving R Hacks (27.2.20)](#orgfa78e21)
    56. [Textmining with R (book - 2014)](#org9f8bda8)
    57. [Geocomputation with R (book - 2018)](#orgbcb5892)
    58. [Build interactive tutorials with learnr (2020)](#org3e5acce)
    59. [Example: setting up R, RStudio, tidyverse R package](#org74925d7)
    60. [R and Jupyter Notebook](#org96c5489)
    61. [Datacamp blog (30 Nov 2016)](#org1ffd412)
4.  [Datasets](#orgf9fe70c)
    1.  [Every Place I’ve Gotten Data For Data Science Projects, Rated](#orgb79e64a)
    2.  [Useful sites for finding datasets for Data Analysis tasks](#orgc76b05d)
    3.  [CDC vital statistics](#org545194f)
    4.  [satellite data](#org35f3d4a)
    5.  [Unsplash’s dataset is now open source](#org5e99b3e)
    6.  [Google dataset search](#org63b434f)
    7.  [HWR Datenbanken](#org7aa649c)
    8.  [Penguins Dataset Overview - iris alternative in R](#org5054d93)
    9.  [Cleaning Data in R (datacamp course) - case studies](#org93f812f)
    10. [Importing data in R (datacamp course)](#orgfa77859)
    11. [Google datasets](#org3e25261)
    12. [How to Collect Data for Your Analysis (June 6, 2020)](#org0a8c4a6)
    13. [data.gov.uk](#org7afe794)
    14. [17 Free Financial & Economic Datasets for Machine Learning](#org43461ab)
    15. [AWS Open Datasets](#org63b8262)
    16. [Amazon Customer Reviews](#orgd936fad)
    17. [Getting Started With SpaceNet Data](#org6ab8bfc)
    18. [18 Places to Find Free Data Sets for Data Science Projects](#org8c5da7a)
    19. [Andrew Heiss' collection (political science)](#org8c51131)
    20. [COVID-19 Data Hub](#org1148b96)
    21. [R built in Data Sets](#org99e3659)
    22. [19 Free Public Data Sets for Your Data Science Project](#org9eb184d)
    23. [US Census Bureau - Employment data](#org68c37c7)
    24. [dslabs (HarvardX)](#orge736892)
    25. [Learning R on iris (2016)](#orga196419)
5.  [Blogs worth reading](#org27cb87d)
    1.  [Will Kurt Count Bayesie](#org5779b25)
        1.  [Why Bayesian Stats Needs Monte-Carlo Methods](#orgadab4e1)
    2.  [“One Year of Data Science Blogging — Was it Worth it?”](#org00d64c9)
    3.  [Data Science is a Science (Just Not the One You May Think)](#orgb7ae4cd)
    4.  [Megan Stodel](#orgc36ca47)
    5.  [Anita Graser](#orgf91134a)
    6.  [pete werner - Density plots in ggplot](#org0275ec1)
    7.  [Corey Sparks R blog (demographic modeling - cluster analysis)](#org46750f7)
    8.  [Quantum jitter](#orgcc192f7)
    9.  [Richie Cotton 4D Pie Charts](#orgf01450b)
    10. [Martin Johnsson's blog about genetics](#orgc0302c5)
    11. [Guest blogging R-posts.com](#orgdd46a8d)
    12. [Mathew Analytics (e.g. R code review)](#orgcd79313)
    13. [Statistical modeling, causal inferene, and social science](#org80c3ba4)
    14. [R Rendering - Tylermw](#orgcdbcea8)
    15. [Sebastian Kranz](#org10738a6)
    16. [18 great blog posts from 2016](#org6d1253e)
    17. [List of top data science blogs 2020 (via Hi! I am Nagdev)](#orgd0648f9)
    18. [Joshua Cook - Riddler](#org72b8086)
    19. [R-Bloggers](#org0e7ac66)
    20. [Radford Neal - COVID-19](#org362f2e5)
    21. [Holker K. von Jouanne-Diedrich](#org1099d50)
    22. [https://physicsgarage.com/](#orgdce448f)
    23. [Publishable Stuff / Rasmus Baath](#orge25cd5d)
    24. [Xi'An's OG](#org846f3b4)
    25. [Radford Neal's blog](#org94d1851)
    26. [Vicky Boykis](#org93cff07)
    27. [Markus Lang](#orged941d1)
    28. [Aerin Kim](#org6258cc8)
    29. [Cassie Kozyrkov](#orgd943d53)
    30. [Tim Gowers](#orgcdf3136)
    31. [RStudio Blog](#org1b8d48d)
    32. [RWeekly](#orge9e90ba)
6.  [Visualization](#orga61b8ce)
    1.  [TwoTone visualizing data with sound and music (Google)](#org08ace67)
    2.  [Visualizing Google Data (via trends.google.com)](#org43e7a40)
    3.  [Finding the Shortest Path with Dijkstra’s Algorithm](#orgfa2cfb5)
    4.  [Snap! visualization - pointillism](#org6a46b6c)
    5.  [A short tutorial for decent heat maps in R](#orgae2700e)
    6.  [Challenges](#org5341970)
        1.  [Does the chart support the text? (COVID-19 and economic data)](#org8fc3c5c)
        2.  [Issues with the "flatten the curve" meme and chart? (FastCompany 13 March 2020)](#org547bf71)
    7.  [D3.js — How to Make a Beautiful Bar Chart With The Most Powerful Visualization Library](#org3ac5b72)
    8.  [“What Data Visualisation Experts Wish They Knew When They First Started”](#org7b26bda)
    9.  [Tutorial: Plotting in R for Python Refugees](#org7902440)
    10. [Microsoft Research: Expressive Pixels](#org012932b)
    11. [Most popular on Netflix. Daily Tops for last 60 days](#org4f410a0)
    12. [How dynamic is the browser market?](#orgaa5f243)
    13. [Energy consumption in last 140 years](#orgff0307f)
    14. [Gapminder](#orgf67fcbd)
        1.  [How to build Animated Charts like Hans Rosling — doing it all in R](#orga8f1362)
        2.  [Exploring the Gapminder Data with R](#org5aff77c)
        3.  [Empfehlungen Roland Müller (Rosling pro and con):](#orgbfa14cf)
    15. [ggplot](#orgaba211d)
    16. [Create a line graph with ggplot](#orgfa4b173)
        1.  [Dataquest beginner's tutorial ggplot2](#org15bc2aa)
        2.  [Graphics in R with ggplot2](#org3930648)
        3.  [ggplot2 easthetics cheat sheet](#org238f5ee)
        4.  [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#org120d840)
        5.  [A ggplot2 Tutorial for Beautiful Plotting in R](#org9ec3661)
        6.  [Tutorial: why data visualization is important (ggplot2)](#orgf32cbbb)
        7.  [Writing Functions to Automate Repetitive Plotting Tasks in ggplot2](#orga6acf55)
        8.  [a ggplot2 grammar guide](#org0ad4f4a)
        9.  [Top 50 ggplot2 Visualizations - The Master List (with full R code)](#orgde517bd)
        10. [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#org60cd676)
    17. [Abstractions - Physarum model visualizations](#orgad002a2)
    18. [You’re Plotting the Wrong Things](#org61886cd)
    19. [Analytics is not storytelling (Kozyrkov](#org51056bd)
    20. [You Can Design a Good Chart with R](#org83c1d5f)
    21. [The Goldilocks Principle - investing in stocks (beautiful graphs)](#org22b3ab7)
    22. [Embed Interactive Plots in Your Slides with Plotly](#orgff9e448)
    23. [PowerPoint is evil (E Tufte, 9 Jan 1983)](#org7124f48)
    24. [Cheesecake Diagrams: Pie Charts with a Different Flavour](#org9708e27)
    25. [Demo: Create beautiful charts with Datawrapper](#org2857109)
    26. [Making tables with the gt package](#org0db279d)
    27. [A Comprehensive Guide to the Grammar of Graphics for Effective Visualization of Multi-dimensional Data](#org59a8c1b)
    28. [Package for colorblind plots](#org570ea28)
    29. [Guide to gt tables (Richard Iannone)](#org7a45234)
    30. [Visualization examples](#org2514fad)
        1.  [Making Interactive Maps in R with Less Than 15 Lines of Code](#org069367d)
        2.  [Sqrt(2) puzzle animation](#org2541294)
        3.  [Power socket types Europe (Twitter account gesperrt!)](#org59cb3a0)
        4.  [Size of Africa](#orgc8ba719)
    31. [fabricerin package to draw on shinyapp documents (?)](#orge0baf6a)
    32. [The ultimate EDA visualization in R (raincloud plots)](#org49b9161)
    33. [SpaceX Satellites Ruin Perfectly Good View of Comet NEOWISE](#org7968c08)
    34. [Re-engineer graphs to extract the data (WebPlotDigitizer)](#org10631b2)
    35. [COVID-19 cases in India drop every Sunday - how to explain?](#org5de2357)
    36. [Animated charts: visualizing “changes” in R](#org084d689)
    37. [Making Interactive Maps of Public Data in R by Ryan Rosenberg](#orgca1827e)
    38. [ggtext - formating text in graphs](#orgb85e130)
    39. [A Layered Grammar of Graphics](#org092bf52)
    40. [My top 5 visualization tools for data science](#org17f9c4e)
    41. [Visualization good/bad examples](#org23d2abd)
    42. [How to Visualize Data with R](#orga762d49)
    43. [Hadley Wickham: Managing many models with R (2016)](#orgaa59b4c):modeling:R:wickham:video:
    44. [Past project examples (Andrew Heiss)](#orgde9758e)
    45. [R Visualizations David Gerbing 2020](#orgdf6c0fe)
    46. [Online course in data visualization with R (May 2020) - Georgia State U / Dr Andrew Heiss](#orgb219e5b)
    47. [Free book: Data Visualization with R (Rob Kabacoff, 2018)](#org289bd56)
    48. [Free book: Data Visualization - A practical introduction](#org2f7e7a7)
    49. [Free book: Fundamentals of Data Visualization by Claus O Wilke](#org9d8f7eb)
    50. [Easy Ways to Make Your Charts Look More Professional 28 May 2020](#org6c0f047)
    51. [Stacked Bar Graphs, Why and How 28 May 2020](#orgae64e78)
    52. [Effective Visualizations for Credible, Data-Driven Decision Making (16.4.20)](#org2a4d1e2)
    53. [Visualisation example: Data Privacy in the Age of Big Data](#org5c50afc)
    54. [Practical Implications of Sharing Data: A Primer on Data Privacy,](#org06e2f99)
7.  [RMarkdown / R Notebook / learnr / RTutor / OER](#org7da9838)
    1.  [From R to WordPress in two easy steps](#orgd114ad8)
    2.  [Image clipper into RStudio (add-in)](#org3833537)
    3.  [Getting started with R and RStudio (Dataquest tutorial)](#org650562a)
    4.  [Replacing PowerPoint with R](#org7b082eb)
    5.  ["Dashboards are dead" see also https://count.co](#org4d81b36)
    6.  [Interactive R tutorials with learnr (youtube)](#org2390a5b)
    7.  [Tips and tricks in RStudio and R Markdown](#org824c4bc)
    8.  [Jupyter Notebooks](#org51fac94)
    9.  [Literate Programming](#orga2ae3ed)
        1.  [Org-mode litprog in Emacs (2018) - long youtube video](#org880834e)
        2.  [Configuring Emacs with Org mode and literate programming](#orga3d8b36)
        3.  [Interview with Donald Knuth (1993) - LitProg, CWEB](#org78f4e84)
        4.  [Stanford page on LitProg](#org385b4ee)
        5.  [LitProg article by Knuth 1984](#org7889739)
        6.  [The CWEB System of Structured Documentation (1993-2001)](#org157cbe9)
        7.  [LitProg - Propaganda and Tools (Christopher Lee 1994)](#org8891e40)
    10. [DS in education](#orgc80a049)
        1.  [Open-Source Authorship of Data Science in Education Using R,](#org6fe96cb)
    11. [R Markdown](#org610555f)
        1.  [Converting LaTeX to Bookdown (accessible lecture notes)](#orgb4babcd)
        2.  [How R Markdown changed my life (video 23 min)](#org59f1d8e)
        3.  [Meta RMarkdown - Taxonomy and Use cases](#org973234b)
        4.  [Useful YAML options for generating HTML reports in R](#org67c6cc8)
        5.  [R Markdown Crash course (bookdown)](#orgf648b00)
        6.  [Book: Practical R for Mass Communication and Journalism](#org995cb53)
        7.  [Course: Datacamp course R Markdown](#org95b973a):datacamp:
        8.  [RTutor](#orgf2578b6)
        9.  [Interactive Tutorials for R](#org6608d13):R:learnr:
        10. [Markdown + XMInd (Blog)](#orgc41b720)
        11. [How I teach R Markdown 29.5.2020](#org16b5e56)
        12. [Making slides with xaringan 16.1.2019](#org88b8ced)
        13. [R Markdown Tutorial (Video 2018, 8 min)](#orgc4f8628)
        14. [Advantages of Using R Notebooks For Data Analysis Instead of Jupyter Notebooks (6.6.17)](#org7e3a9e9)
        15. [Markdown Tutorial](#org759cea2)
        16. [Pimp my RMD: a few tips for R Markdown by Yan Holtz - 10 December 2018](#org5c348c5)
        17. [Bookdown - R Markup](#org952e997)
        18. [R Markdown from R Studio](#orga1da9c1)
    12. [learnr](#org86fe80e)
        1.  [Teaching in learnr](#orge6fe4c3)
        2.  [Publishing learnr Tutorials on shinyapps.io](#org273834c)
8.  [Emacs / ESS](#org32ae489)
9.  [Teaching - other courses and ideas](#org8f964db)
    1.  [R for Journalists (tutorial)](#orgd81015e)
    2.  [Learning guide: Introduction to R, one-day workshop](#org85685c5)
    3.  [STAT 220 labs Amelia McNamara](#orga68b66c)
    4.  [A fresh look at introductory data science (paper 2020)](#org6ecef43)
    5.  [Data science in a box (tidyverse, learnr)](#orga260159)
    6.  [DS112 tutorials (net apps, learnR and GitHub exercises)](#org23f9c58)
        1.  [R Basics](#orgdf59e6b)
        2.  [ggplot() and dplyr tutorial](#org85104de)
    7.  [Teaching Statistics with R](#org3401188)
    8.  [Future of Statistical Programming](#orge6bde05)
    9.  [Bridging the Gap Between Tools for Learning and for Doing Statistics](#org7107f57)
    10. [Codementor](#orgd092550)
    11. [Online course: Adventures in R](#org0d7389a)
    12. [Proposal for an educational data science course](#org7218bbf)
    13. [R Studio Cloud Primers](#org4f49855)
    14. [How I Taught Scientific Blogging with R Markdown, Online](#org1b90e23)
    15. [RStudio Instructor Certification Exams](#orge7218f3)
    16. [Market analysis course (interactive, free, and with a lot of R)](#org1182a7a)
    17. [R for Bio Data Science (DTU Wiki)](#org4e69386)
    18. [Data science for biologists (playlist youtube)](#orgd8c3d82)
    19. [A novice’s guide to learning to code with CS50](#orge9826f9)
    20. [Introduction to SQL (Coursera)](#orge684bb4)
    21. [Syllabus](#orge52426f)
    22. [Mismatch Between Academic and Real-world Data Science Projects](#org147d31d)
    23. [UC Berkeley Connector Courses](#orgcf73251)
    24. [John DeNero | YouTube |  Intro Foundations of Data Science Intro | Online Book](#orga0d4426)
    25. [Computational and inferential thinking | Online book](#org35bec5a)
    26. [Data 8 - The foundations of data science (UC Berkeley) | Site: data8.org | Spring 2020 syllabus](#orga492c9a)
    27. [Harvard edX Program](#org9408d8d)
    28. [Heidi Seibold | video 55 min |  presentation](#org02c21f8)
    29. [The Johns Hopkins Data Science Lab](#org720c418)
10. [Data wrangling](#org260a287)
    1.  [Cleaning ecological survey data for conservation scientists](#orgbc09854)
    2.  [Cleaning messy data with tidyverse](#orgcdc07a0)
    3.  [Data Cleaning and Exploratory Analysis in Python and R](#org05d027a)
    4.  [Beyond Ordinary PCA: Nonlinear Principal Component Analysis](#orgbdc8401):medium:
11. [Git/Github](#org84b8256)
    1.  [Happy Git and GitHub for the useR (bookdown)](#orgfcac662)
    2.  [Git Emacs integration](#org283625d)
    3.  [How to upload your R code on GitHub: example with an R script on MacOS](#org33a8280)
    4.  [The State of the Octoverse](#org5cf3dce)
    5.  [Building a blog using github and jekyll](#org8ee1fcb)
    6.  [Using GitHub Actions for MLOps & Data Science](#orgdc49075)
    7.  [BIRKENKRAHE @github](#orgc40abee)
    8.  [Git Your SQL Together (with a Query Library)](#org30e8a4f)
    9.  [Using GitHub Classroom to teach statistics (paper 2019)](#orgbe922fd)
    10. [How to use Git and Github with R (15 min video)](#orge5c2496)
    11. [How to upload your R code on GitHub: example with an R script on MacOS (24.5.20)](#orgeed47cc)
    12. [Why You Should Blog with Hugo?An Introduction to the 'Blog with Hugo'](#org4dab1ae)
12. [Mixed Links](#orgddae456)
13. [Math](#org9703d60)
    1.  [Modeling](#org7cd9d9a)
        1.  [Tidy Modeling with R (Kuhn & Silge, 2020)](#orgd866060)
        2.  [Feature Engineering and Selection: A Practical Approach for Predictive Models](#org6f8646a)
    2.  [ML](#org5b96b8e)
        1.  [Math Companion to The Art of Machine Learning](#org73d671f):matloff:pdf:
    3.  [Stats](#org13f7504)
        1.  [Daniela Witten's "Four Cardinal Rules of Statistics" (Tweets)](#org031cb4b)
        2.  [The Lacking Wisdom of Crowds](#org695778a)
        3.  [Why Bayesian Stats Needs Monte-Carlo Methods](#org0bea6ec)
        4.  [Introduction to Probability (2nd 3d) PDF](#org635539d)
        5.  [A trick question for data science buffs](#orgdff19a4)
        6.  [Descriptive vs Inferential Statistics in One Picture](#orgaa2b9e5)
        7.  [What the Null Hypothesis Really Means— According to a Statistics Professor](#org5a7d1ba)
        8.  [P-values Explained By Data Scientist](#org6243400)
        9.  [How most statistical tests are linear models (with cheat sheet)](#orgf76edd8)
        10. [What is p-value short for? (Kozyrkov)](#org0e315fd)
        11. [The Magic of The Bell Curve (turn Python script into R)](#org6bcf6e3)
        12. [Monte Carlo Simulation in R (see also Matloff 2020)](#orgfee7874)
        13. [Outliers detection in R](#org8557765)
        14. [Stop using p=0.05](#org4baedcd)
        15. [Essentially random isn't the same as actually random](#org349b6b9)
    4.  [General maths](#org4742f04)
        1.  [The Directed Edge Reinforced Random Walk: The Ant Mill Phenomenon](#orgf2716bf)
        2.  [Understanding Mathematical Symbols with Code](#orgd22b530)
        3.  [A computational approach to the Prisoner’s Dilemma](#org229e95e)
        4.  [What is Graph Theory, and why should you care?](#orgb474989)
        5.  [Matrices are Graphs (12 Aug 2020)](#org27c30e2)
        6.  [The Fastest Way to Compute the Fibonacci Sequence](#org1b7fb97)
        7.  [The Collatz Conjecture](#orgaf53dbf)
        8.  [The Riemann Hypothesis, explained](#orgc0920b3)
        9.  [What is the determinant?](#orgd48bc46)
        10. [A Tribute to Leonard Euler (youtube)](#org1d4d834)
        11. [Philosophy of Mathematics (Stanford Encyclopedia of Philosophy)](#org030ff8f)
        12. [Introduction to Group Theory (see also book by Charles Pinter, kindle)](#org6b8a42e)
        13. [Six Difficult Ways of Becoming a Millionaire by Francesco Di Lallo](#org61a645d)
        14. [The algebra and machine representation of statistical models (PhD)](#org4a7a4fb)
        15. [Mathematics for machine learning (book)](#orgafffa57)
        16. [Statistics with R specialization @Coursera](#orgcb60a51)
        17. [Business statistics and analysis specialization @Coursera](#org8d8c944)
        18. [Statistics and probability in data science using Python](#org1ef7523)
        19. [Linear algebra: foundations to frontiers @edX](#orgbbef0aa)
        20. [Mathematics for machine learning: linear algebra @Coursera](#orgf2f71ac)
        21. [Pre-university calculus @edX](#orgdcf0d54)
        22. [Calculus I @KhanAcademy](#org38162f9)
        23. [Mathematics for machine learning: multivariable calculus  \* Discrete Mathematics <code>[0/8]</code>](#org0fbb08d)
        24. [Introduction to discrete mathematics for computer science specialization @Coursera](#org4be5f92)
        25. [Introduction to mathematical thinking @Coursera](#org8567296)
        26. [Master discrete mathematics: sets, math logic, and more @Udemy](#org29c3ee5)
        27. [Optimization methods in business analytics @edX](#orgf7322fa)
        28. [Discrete optimization @Coursera](#org0a0f010)
        29. [Deterministic optimization @edX](#org65d86af)
14. [NN](#org771ba66)
    1.  [Artificial Neural Networks for Neuroscientists: A Primer](#orgd6015d2)
    2.  [The Neural Network, A Visual Introduction | Visualizing Deep Learning](#orga27ee5a)
    3.  [RobustFill: Neural Program Learning under Noisy I/O (2017)](#orgd68dc63)
    4.  [Building a neural net from scratch using R (part 1, part 2)](#org460f609)
    5.  [The Beginner’s Glossary of Neural Network Terms](#orgec653e0)
    6.  [Every Machine Learning Algorithm Can Be Represented as a Neural Network](#org64204fe)
    7.  [NN and ML vs Stats (culture wars)](#orgd229425)
    8.  [BrainOS — The Most Brain-Like AI](#org1d51142)
    9.  [Understanding How Neural Networks Think](#orge3d032c)
    10. [Can you remove 99% of a neural network without losing accuracy?](#org59ef17e)
    11. [Symbolic Mathematics Finally Yields to Neural Networks](#org087abe5)
    12. [Explainable AI: Neural Networks (IBM)](#org9bde92c)
    13. [Why are neural networks so powerful?](#orgc323ae9)
    14. [22 articles about NN Jan 2019g](#orgc61ef3e)
15. [RStudio / IDEs / GUI](#org00a674d)
    1.  [GUIs and the Future of Work](#org89002b6)
    2.  [RStudio addins, or how to make your coding life easier](#orge8974bd)
    3.  [Do, Share, Teach, and Learn Data Science with RStudio Cloud, Lou](#org954e264)
    4.  [A Dashboard of Shiny Apps by Andy Merlino 2020/07/17](#orgd33baac)
    5.  [keyboard shortcuts and tips and tricks](#org34bc575)
    6.  [Using version control with RStudio](#orga5d832f)
    7.  [Interactive code with Shiny - Example](#org725dfc4)
    8.  [Xaringan presentations](#orgf6b76be)
    9.  [Connections window / database connections in RStudio](#org1e16163)
    10. [RStudio Primers (cloud) created using learnr (github)](#org9d92e46)
    11. [RStudio Blog](#org1231288)
16. [AI/ML](#orge863d49)
    1.  [Self-Organizing Intelligent Matter: A blueprint for an AI generating algorithm](#org87dccf1)
    2.  [R packages for eXplainable Artificial Intelligence](#org0e462d7)
    3.  [A Beginner’s Guide To Computer Vision](#org406be97)
    4.  [How I Explained Word Embeddings To My Non-Technical Colleagues](#org8e770d5)
    5.  [The Difference Between AI and Machine Learning (datacamp blog)](#org6af59ca)
    6.  [Supervised Machine Learning for Text Analysis in R](#org2c4004d)
    7.  [What Types of Questions Can Data Science Answer?](#org263c3c5)
    8.  [Deep AI engines example "How to become a data scientist in 30 days?"](#org0648429)
    9.  [Game Theory for Data Scientists](#org66b6716)
    10. [Facial Recognition Bans: What Do They Mean For AI (Artificial Intelligence)?](#org21dc030)
    11. [Core progress in AI has stalled in some fields 29.5.20](#org96f3654)
    12. [The limits of knowledge - Gödel, Turing, and the science of what we can and cannot know](#orgcb2a7e8)
    13. [Computing Machinery and Intelligence (A M Turing 1950)](#orgb431c58)
    14. [What is the relevance of Gödel's theorem(s) to AI?](#orge79e3c1)
    15. [Platonist Roger Penrose “Sees” Mathematical Truths (19 May 2020)](#org5861233)
    16. [The remarkable evolution of AI (5 May 2020)](#orgc8de80f)
    17. [IBM claims its Neural Computer achieves record AI model training time (14 May 2020)](#org61a1990)
    18. [The computers of nature - Cellular automata and the emergence of computation in natural systems](#org85902e1)
17. [SQL/(R)SQLite](#org05c403d)
    1.  [How To Connect R With SQL (PostGreSQL)](#org6874204)
    2.  [How to Learn SQL (Datacamp blog)](#org3fe51c8)
    3.  [Machine learning example with SQL only](#org02c66b8)
    4.  [Data Lakes vs. Data Warehouses](#orgffc5403)
    5.  [Apache Spark, JDBC, sparklyr](#org530978c)
    6.  [R and ODBC – Pulling Data From A SQL Database](#orgfa02c97)
    7.  [4 SQL Tips for Data Scientists and Data Engineers](#orgb1b5de4)
    8.  [SQL equivalents in R](#org0631f6d)
    9.  [Building Complex SQL Queries with R](#org786ffcb)
    10. [Ten SQL Concepts You Should Know for Data Science Interviews](#orge0fb972)
    11. [Linear Regression with SQL (whitepaper) & R Notebook](#org546502e)
    12. [Using SQL in RStudio (29.4.20)](#org9d75f83)
    13. [Appropriate uses for SQLite](#orgb7cc0c2)
    14. [Relational Algebra (tutorialspoint)](#org6bcc737)
    15. [RSQLite](#org40852e6):rsqlite:
        1.  [access in RStudio with the connections pane](#org0e75071)
        2.  [Read Data from an SQLite Database (video 8 min)](#orgeab5d76)
        3.  [RSQLite = SQLite in R](#org23db458)
        4.  [Beginners Guide to SQLite (in R)](#org5ff6c2f)
    16. [JSON (JavaScript Object Notation) Files](#org4ecb337)
        1.  [RJSON package](#org3e37df6)
        2.  [Tutorial: Working with Large Data Sets using Pandas and JSON in Python](#orgf585351)
    17. [SQL Joins Grafik](#orgb42c67a)
    18. [SQL Data Types (Mode)](#org49434b0)
    19. [Crunchbase - data dashboard solution](#orgf699a64)
    20. [SQL for Data Scientists, in Under 6 Minutes](#orgad4ece4)
    21. [SQL Case Study: Investigating a Drop in User Engagement](#org4132d63)
    22. [SQL Case Study: Investigating a Drop in User Engagement (21 May 2020)](#org96a5663)
18. [NLP](#orgde92a91)
    1.  [State-of-the-art NLP models from R:](#orgb40f38d)
    2.  [A Guide to Text Annotation — the Key to Understanding Language](#org290d971)
    3.  [Datacamp: natural language processing in R](#orge1d622a)
19. [Blockchain](#org6bf0e69)
...
-   [covdata - COVID-19 specific case and mortality data](#orgbabd94d)


<a id="org0e147b4"></a>

### [Issues with the "flatten the curve" meme and chart? (FastCompany 13 March 2020)](#org547bf71)


<a id="orgf7cf89f"></a>

### [COVID-19 cases in India drop every Sunday - how to explain?](#org5de2357)
...
## [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#org120d840)
...
### [Does the chart support the text? (COVID-19 and economic data)](#orgaa0a3fe)
...
### [Storytelling with Data and ggplot: Visualising the Receding Ice Sheets](#orgc6f5ea3)
...
## [The Goldilocks Principle - investing in stocks](#org65a560a) (beautiful graphs)
...
-   [Git Emacs integration](#org283625d)
...
### [Why Bayesian Stats Needs Monte-Carlo Methods](#orgadab4e1)
